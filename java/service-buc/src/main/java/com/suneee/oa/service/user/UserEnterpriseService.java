...
public class UserEnterpriseService extends UcpBaseService<UserEnterprise>{
	 ...
	 * @param needSync
	 */
	public void delByUserIdAndEnterpriseCode(Long userId, String enterpriseCode, boolean needSync) throws IOException {
	 ...
	 * @param needSync
	 */
	public void delById(Long userEnterpriseId, boolean needSync) throws IOException {
	 ...
	 */
	public void saveUserEnterprise(SysUser sysUser, boolean needSync) throws IOException {
