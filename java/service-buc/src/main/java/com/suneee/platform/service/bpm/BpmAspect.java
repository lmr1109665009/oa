...
import com.suneee.core.annotion.WorkFlow;
...
import com.suneee.platform.service.bpm.util.BpmAspectUtil;
...
public class BpmAspect {
	...
	private void saveData(WorkFlow workFlow ) throws Exception{
		...
		//新增。
		if(processRun==null){
			processRun=processRunService.initProcessRun(bpmDefinition, cmd,null);
			if(dataType.equals(DataType.STRING)){
