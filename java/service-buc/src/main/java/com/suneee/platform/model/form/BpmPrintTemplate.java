...
public class BpmPrintTemplate extends BaseModel
{
	...
	// 是否在流成结束后显示打印按钮 {0:否，1:是}
	@XmlAttribute
	protected Short isPrintInFinish;
	// 是否显示普通表单打印按钮 {0:否，1:是}
	@XmlAttribute
	protected Short isPrintInForm;
	...
	public Short getIsPrintInFinish() {
		return isPrintInFinish;
	}
	public void setIsPrintInFinish(Short isPrintInFinish) {
		this.isPrintInFinish = isPrintInFinish;
	}
	public Short getIsPrintInForm() {
		return isPrintInForm;
	}
	public void setIsPrintInForm(Short isPrintInForm) {
		this.isPrintInForm = isPrintInForm;
	}
	/**
