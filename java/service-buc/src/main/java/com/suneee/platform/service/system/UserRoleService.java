...
import com.suneee.platform.dao.system.UserRoleDao;
...
public class UserRoleService extends BaseService<UserRole> {
	 ...
	 */
	public void delByUserIdAndEnterpriseCode(Long userId, String enterpriseCode){
		userRoleDao.delByUserIdAndEnterpriseCode(userId, enterpriseCode);
	}
