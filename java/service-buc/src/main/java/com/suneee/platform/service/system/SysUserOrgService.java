...
public boolean getUserCount(Long userPosId){
	 ...
	 *登录时获取组织
	 */
	public List<Map> getPrimaryOrgByUserId(Long userId) {
		List<Map> primaryOrgByUserId = dao.getPrimaryOrgByUserId(userId, CookieUitl.getCurrentEnterpriseCode());
		return primaryOrgByUserId;
	}
