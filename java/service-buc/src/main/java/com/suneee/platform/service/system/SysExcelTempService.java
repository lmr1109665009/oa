...
import com.suneee.core.excel.style.Align;
...
import com.suneee.platform.dao.system.SysExcelTempDao;
import com.suneee.platform.dao.system.SysExcelTempDetailDao;
import com.suneee.platform.model.system.SysExcelTemp;
...
public class SysExcelTempService extends BaseService<SysExcelTemp> {
    ...
    private String getStringCellValue(Cell cell) {
        ...
        case HSSFCell.CELL_TYPE_STRING:
            ...
            break;
        case HSSFCell.CELL_TYPE_NUMERIC:// 注意：从excel里面拿出的日期类型是number的
        	if(cell.getDateCellValue() != null && cell.getCellStyle() != null &&
        			cell.getCellStyle().getDataFormatString().contains("y")){	
        		Date date = cell.getDateCellValue();
        		String dataFormat = cell.getCellStyle().getDataFormatString();
        		if(dataFormat.contains("h")){
        			dataFormat = "yyyy-MM-dd hh:mm:ss";
        		}else{
        			dataFormat = "yyyy-MM-dd";// 默认的日期格式，其他日期格式，不做处理
        		}
        		SimpleDateFormat sdf = new SimpleDateFormat(dataFormat);//默认格式
