...
import com.suneee.platform.dao.system.SysWordTemplateDao;
...
public class SysWordTemplateService extends BaseService<SysWordTemplate>
{
	...
	public Map<String, Object> preivew(SysWordTemplate sysWordTemplate, Long pk) throws Exception{
		...
		if(SysWordTemplate.FORM_TYPE.equals(type)){
			BpmFormData data = bpmFormHandlerService.getByTableIdPk(sysWordTemplate.getTableId(), businessKey);
			...
			JdbcTemplate template = JdbcTemplateUtil.getNewJdbcTemplate(dsAlias);
