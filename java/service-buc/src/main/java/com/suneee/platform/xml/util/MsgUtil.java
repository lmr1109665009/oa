package com.suneee.platform.xml.util;
...
public class MsgUtil {
	...
	private static ThreadLocal<Map<Integer,String>> msgMap=new ThreadLocal<Map<Integer,String>>();
	...
	public static void addMsg(int type, String msg) {
		...
		Map<Integer,String> map=msgMap.get();
	...
	public static Map<Integer, String> getSimpleMessage(boolean clean) {
		Map<Integer,String> map=msgMap.get();
		if (clean){
			msgMap.remove();
		}
