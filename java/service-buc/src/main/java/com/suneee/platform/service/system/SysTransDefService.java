...
import com.suneee.platform.dao.system.SysTransDefDao;
...
public class SysTransDefService extends BaseService<SysTransDef> {
	...
	public void excuteUpdateSql(SysTransDef sysTransDef, SysUser author, SysUser targetPerson, String selectedItem) {
