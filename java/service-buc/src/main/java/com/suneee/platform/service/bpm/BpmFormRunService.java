...
import com.suneee.platform.model.bpm.BpmFormRun;
...
public class BpmFormRunService extends BaseService<BpmFormRun>
{
	...
	private BpmFormRun getByBpmNodeSet(Long runId,String actInstanceId,BpmNodeSet bpmNodeSet) {
		...
		if(StringUtil.isNotEmpty(bpmNodeSet.getMobileFormKey())){
			BpmMobileFormDef mobileForm= bpmMobileFormDefDao.getDefaultByFormKey(bpmNodeSet.getMobileFormKey()) ;
			if(mobileForm!=null){
				bpmFormRun.setMobileFormId(mobileForm.getId());
