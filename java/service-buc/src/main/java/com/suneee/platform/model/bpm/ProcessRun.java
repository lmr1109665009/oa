...
public class ProcessRun extends BaseModel implements Cloneable,IProcessRun {
	...
	/** 子流程草稿状态 */
	public static final Short STATUS_SUBPROCESS_FORM=40;
	/** 已撤销 */
	...
	public int getStartFromMobile() {
		return startFromMobile;
	}

	public void setStartFromMobile(int startFromMobile) {
		this.startFromMobile = startFromMobile;
	}
