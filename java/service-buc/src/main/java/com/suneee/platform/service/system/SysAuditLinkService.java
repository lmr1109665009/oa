...
import com.suneee.platform.service.worktime.VacationService;
...
//		return getSysDataSourceLink(source);
	 ...
	 * @return
	 */
	public String getJobLink(Job job){
		return "<a href='#' hrefLink='../../system/job/get.ht?jobid="+job.getJobid()+"' class='JobLink' jobId='"+job.getJobid()+"' >"+job.getJobname()+"</a>";
	}
