...
public class SysUser extends BaseModel implements UserDetails ,ISysUser {
	...
	public String toString() {
		return "SysUser{" +
				...
				", pwdUpdTime=" + pwdUpdTime +
				", hasSyncToWx=" + hasSyncToWx +
				", fromType=" + fromType +
				", roleNames='" + roleNames + '\'' +
				", sn=" + sn +
				", webSignUrl='" + webSignUrl + '\'' +
				...
				", userName='" + userName + '\'' +
				", path='" + path + '\'' +
				", userEnterprises=" + Arrays.toString(userEnterprises) +
				", userEnterpriseinfoJson='" + userEnterpriseinfoJson + '\'' +
				", birthday='" + birthday + '\'' +
	...
	public static JSONObject toJsonObject(SysUser sysUser){
		...
		jsonObj.put("birthday", sysUser.getBirthday());
		jsonObj.put("headImgPath", sysUser.getHeadImgPath());
		jsonObj.put("signature", sysUser.getSignature());
		return jsonObj;
	}
