package com.suneee.core.web.query.scan;
...
import com.suneee.core.annotion.query.Table;
	...
	public void constractSearchTableList() throws IOException,
		...
		for (Class<?> cls : tableList) {
			...
			for (Field field : fields) {
				com.suneee.core.annotion.query.Field qField = field
						.getAnnotation(com.suneee.core.annotion.query.Field.class);
				if (qField != null) {
