...
import com.suneee.core.table.colmap.DmColumnMap;
...
import com.suneee.core.page.PageBean;
import com.suneee.core.table.BaseDbView;
...
//		jdbcHelper=JdbcHelper.getInstance();
		Map map = new HashMap();
		List<ColumnModel> list = JdbcTemplateUtil.getNamedParameterJdbcTemplate(jdbcTemplate).query(sql, map,new DmColumnMap());
