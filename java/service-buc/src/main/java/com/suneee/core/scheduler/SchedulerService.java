package com.suneee.core.scheduler;
...
//	@Resource
	 ...
	 * @throws SchedulerException
	 */
	public JobDetail getJobDetailByName(String jobName) throws SchedulerException{
		if(scheduler==null ){
			return null;
			}
		JobKey key=new JobKey(jobName, schedGroup);
	...
	public void updateTrigger(String jobName,String trigName, String planJson) throws SchedulerException, ParseException{
		if(scheduler==null ){
			return ;
		}
		JobKey jobKey=new JobKey(jobName, schedGroup);
	...
	public void updateJobDetailTri(JobDetail jobDetail, Set<Trigger> triggersForJob, boolean replace)throws SchedulerException{
