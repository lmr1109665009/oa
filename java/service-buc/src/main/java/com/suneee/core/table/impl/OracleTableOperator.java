...
//		}
	...
	private Boolean isForeignKeyExist(String tableName,String keyName){
		String sql = "select count(1) from user_constraints t where t.table_name = upper('"+tableName+"') and t.constraint_type = 'R' and t.constraint_name = upper('"+keyName+"')";
	...
	public void dropForeignKey(String tableName, String keyName) {
		if(isForeignKeyExist(tableName, keyName)){
...
//		}
	...
	public TableIndex getIndex(String tableName,String indexName){
		...
		List<TableIndex> indexes = jdbcTemplate.query(sql, new RowMapper<TableIndex>(){
