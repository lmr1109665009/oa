 ...
 * 
 */
package com.suneee.ucp.base.common;
...
public interface Constants {
	...
	/** 用户默认角色ID **/
	public static final String USER_DEFAULT_ROLEID = "user.default.roleid";
	/** 用户默认角色名称 **/
	public static final String USER_DEFAULT_ROLENAME = "user.default.rolename";
	/** 是否过期 **/
	public static final String USER_DEFAULT_ISEXPIRED = "user.default.isexpired";
	/** 是否锁定 */
	public static final String USER_DEFAULT_ISLOCK = "user.default.islock";
	/** 当前状态 **/
	public static final String USER_DEFAULT_STATUS = "user.default.status";
	/** 员工状态 **/
	public static final String USER_DEFAULT_USERSTATUS = "user.default.userstatus";
	/** 性别 **/
	public static final String USER_DEFAULT_SEX = "user.default.sex";
	/** 邮箱后缀 **/
	...
	/** 用户中心接口地址 **/
	public static final String UC_API_URL = "uc.api.url";
	/** 账号 **/
	public static final String UC_LOGIN_ACCOUNT = "uc.login.account";
	/** 密码 **/
	public static final String UC_LOGIN_PASSWORD = "uc.login.password";
	/** 客户端IP **/
	public static final String UC_CLIENTIP = "uc.clientip";
	/** 应用系统编码 **/
	public static final String UC_APPCODE = "uc.appcode";
	/** 企业编码 **/
	public static final String UC_ENTERPRISECODE = "uc.enterprisecode";
	/** 加密密钥 **/
	public static final String UC_ENCRYPTCODE = "uc.encryptcode";
	/** 数据变动来源系统 **/
	public static final String UC_SYSTEM = "uc.system";
	/** 同步到用户中心的默认密码 **/
	public static final String UC_DEFAULT_PASSWORD = "uc.default.password";
	/** 用户中心批量导入接口 **/
	...
	/** 消息队列接口地址（用于用户组织消息推送buc和内部消息中心） **/
	public static final String MESSAGE_CENTER_API_URL = "messagecenter.api.url";

	/** 内部消息中心推送用户topic(用于buc对IM用户相关同步)**/
	public static final String MESSAGE_USER_TOPIC ="messagecenter.user.topic";

	/** 内部消息中心推送用户topic(用于buc对IM组织相关同步)**/
	public static final String MESSAGE_ORG_TOPIC ="messagecenter.org.topic";

	/** 内部消息中心推送用户topic组**/
	public static final String MESSAGE_RECEIVECROUP_TOPIC ="messagecenter.receiveGroup.topic";

	/** 内部消息中心推送(推送方)*/
	public static final String MESSAGE_SEND ="BUC";

	/** 内部消息中心推送(接收方)*/
	public static final String MESSAGE_SYSTEM ="IM";

	public static final String MESSAGE_STATUS_ADD ="ADD";
