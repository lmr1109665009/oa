...
public class TypeManegeController extends UcpBaseController{
	...
	public ModelAndView list(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		// 从数据字典中获取地区列表
		List<Dictionary> regionList = dictionaryService.getByNodeKeyAndEid(ConferenceRoom.REGION_NODE_KEY,CookieUitl.getCurrentEnterpriseCode());
		// 从数据字典中获取流程审批类型
		List<Dictionary> typeList = dictionaryService.getByNodeKeyAndEid("qyzwxg",CookieUitl.getCurrentEnterpriseCode());
