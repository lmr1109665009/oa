...
public class SysOrg extends BaseModel implements ISysOrg {
	...
	public final static Short IS_ROOT_N = 0; // 不是根节点
	public final static Short IS_ROOT_Y = 1; // 是根节点
	...
	public void setParentNum(Integer parentNum){
		...
		if(this.parentNum != null && this.parentNum == 0){
			this.isRoot = IS_ROOT_Y;
		} else {
			this.isRoot = IS_ROOT_N;
		}
	}
	...
	public void setIsRoot(Short isRoot) {
		this.isRoot = isRoot;
		if(isRoot != null && this.isRoot.equals(IS_ROOT_Y)){
			this.parentNum = 0;
		} else {
			this.parentNum = 1;
		}
	...
	public Long getOrgStaff() {
		return orgStaff;
	}
	public void setOrgStaff(Long orgStaff) {
