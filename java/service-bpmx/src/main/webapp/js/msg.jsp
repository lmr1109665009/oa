...
<%@page import="com.suneee.core.web.controller.BaseController"%>
<%@page import="com.suneee.core.web.ResultMessage"%>

<%
    ResultMessage _obj_=(ResultMessage)request.getSession().getAttribute(BaseController.Message);
    if(_obj_!=null){
