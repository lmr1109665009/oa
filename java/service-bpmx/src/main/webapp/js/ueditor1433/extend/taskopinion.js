UE.registerUI('taskopinion', function(editor, uiName) {
	// 创建一个button
	var btn = new UE.ui.Button({
		...
		cssRules : 'background-position: -1000px -20px;',
		// 点击时执行的命令
		onclick : function() {
			...
			var div = $('<div class="taskopinion" instanceid="#instanceId#" parser="taskopinionhistory"><input type="text" /></div>');
			$(element).append(div);
		}
	});
