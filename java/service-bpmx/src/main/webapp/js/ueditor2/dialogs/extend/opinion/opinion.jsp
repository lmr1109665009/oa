...
<title></title>
	...
	<script type="text/javascript">
		...
		dialog.onok = function() {
			...
			html += '<textarea name="'+name+'" opinionname="'+opinionName+'" parser="taskopinionedit" ewidth="'+$('#input-width').val()+'" eheight="'+$('#input-height').val()+'" widthUnit="'+$('#widthUnit').val()+'" heightUnit="'+$('#heightUnit').val()+'" ' ;
