       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['source', '|', 'undo', 'redo', '|',
                ...
                '|','pasteinput','tableformat','choosetemplate_mb','input_mb',
                'insertfunction_mb','numbervalidate','daterangevalidate','datecalculate','help']
        ]
    
    /**,'choosetemplate','opinion','input','wordtemplate', '|','taskopinion','flowchart',
                'insertfunction','cutsubtable','pastesubtable','customquery','uncustomquery','numbervalidate','daterangevalidate','datecalculate'*/
        ...
        ,iframeCssUrl: __ctx +"/js/ueditor2/themes/weixinForm.css" //给编辑器内部引入一个css文件
