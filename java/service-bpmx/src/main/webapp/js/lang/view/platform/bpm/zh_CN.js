var $lang_bpm = {
	...
	task:{
		...
		toStart:{
			...
			warn_msg_reject_opinion:'请填写退回意见! ',
			warn_msg_reject_start_opinion:'请填写退回意见! ',
			warn_msg_complete_or_terminate:'任务已经执行完成或被终止! ',
			success_msg_operate:'执行任务成功!',
			success_msg_reject:"退回成功!",
			success_msg_reject_start:"退回到发起人成功!",
			success_msg_form_save:"保存表单数据成功!",
			error_msg_no_form:"还没有设置表单!",
			error_msg_complete:"执行任务失败!",
			error_msg_terminate:"终止流程失败!",
			error_msg_reject:"退回任务失败!",
			error_msg_reject_start:"退回到发起人失败!",
