    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            if (p.valueFieldID)
            {
                ...
                if (p.valueFieldKey){
                    g.valueField[0].id =p.valueFieldKey;
                }else {
        ...
        createIframe:function(selectBox){
        	...
        	iframeObj.css({left:selectBox.left,top:selectBox.top,width:selectBox.width()+2,height:selectBox.height()})
        ...
        showIframe:function(selectBox){
        	...
        	obj.show();
        	obj.css({ top: selectBox.css("top"), left: selectBox.css("left") , width: selectBox.width()+2,height:selectBox.height() });  
        ...
        setGrid: function (grid)
        {
            ...
            grid.columnWidth = grid.columnWidth || 198;
            grid.width = "100%";
            grid.height = "100%";
            grid.heightDiff = -2;
            grid.InWindow = false;
