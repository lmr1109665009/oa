...
(function(root, factory) {
    ...
    var defaults = {
        ...
        DAY_ITEM_TPL = '<li ' + ITEM_STYLE + ' class="{class}" {action}><i>{value}</i><div class="point"></div></li>',
...
//            '</div>',
    ...
    Calendar.prototype = {
        ...
        getDaysHtml: function(y, m) {
            ...
            firstWeek = new Date(year, month - 1, 0).getDay() || 7;
        ...
        event: function() {
            ...
            _this.$element.on('click', ARROW_DATE, function() {
                ...
                _this.options.onMonthChanged.call();
