...
!function ($) {
    ...
    var Page = function (element, options) {
        ...
        this.options.pageSizeItems = this.options.pageSizeItems || [5, 10, 15, 20,50,100],
    ...
    Page.prototype = {
        ...
        remote: function (pageIndex, params) {
            ...
            $.ajax({
                url: this.options.remote.url+"?currentPage=" + pageIndex + "&pageSize="+ this.currentPageSize,
                //dataType: 'json',
                //data: requestParams,
                ...
                success: function (result) {
                    ...
                    var total = result.data.totalCount; //GetCustomTotalName(result, that.options.remote.totalName);
    ...
    var renderInfo = function (currentPageIndex, currentPageSize, total, infoFormat) {
    	if(currentPageIndex==0){currentPageIndex=currentPageIndex+1}
    ...
    var renderPerPage = function (text, value) {
        return $("<li><a data-page-index='" + parseInt(value+1) + "'>" + text + "</a></li>");
    }
