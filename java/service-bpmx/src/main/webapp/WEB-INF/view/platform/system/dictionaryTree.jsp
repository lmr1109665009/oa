...
<head>
	...
	<script type="text/javascript">
		...
		function layout(){
	        ...
	        $("#glTypeTree").height(height-80);
		};
		//布局大小改变的时候通知tab，面板改变大小
	    function heightChanged(options){
	     	//$("#glTypeTree").height(options.middleHeight - 80);
	    };
		...
		*/
		...
		function editDict(){
			...
			var winArgs="dialogWidth=450px;dialogHeight=250px;help=no;status=no;scroll=no;center=yes";
...
<div id="layout">
	...
	<div position="center" title="数据字典管理（点击右键操作,可以使用鼠标进行拖动)" style=" overflow:scroll">
		<div id="dictTree" class="ztree" style="overflow: initial;"></div>
	</div>
