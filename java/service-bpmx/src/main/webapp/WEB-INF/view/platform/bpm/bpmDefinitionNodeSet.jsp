...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/hotent/platform/bpm/TaskCommunicateUser.js" ></script>
    <script type="text/javascript">
            ...
            $(function (){
              ...
              $("#divContainer").height($(window).height()-$(".l-tab-links ul").height()-$(".panel-toolbar").height()-25)
            });
            ...
            function clickHandler(itemId){
            	...
            	//任务id
            	var activitiId=curObj.attr("id");
            	console.log(activitiId)
            	var activityName=curObj.attr("title");
            	...
            	}else if(itemId=="communicate"){
            		TaskCommunicateUser({nodeId:activitiId,defId:defId,actDefId:actDefId,parentActDefId:parentActDefId});
            	}
	...
	<div class="panel">
		...
		<div id="panel-container"  class="panel-container" >
			...
			<div id="divContainer" style="overflow: auto;" >
				<div style=" margin:20px auto 0;position: relative;background:url('${ctx}/bpmImage?deployId=${bpmDefinition.actDeployId}')  no-repeat;width:${shapeMeta.width+20}px;height:${shapeMeta.height}px;">
						${shapeMeta.xml} 
				</div>
			</div>
		</div>
