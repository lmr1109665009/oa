...
// 			}
	...
	<style type="text/css">
		...
		.inputText {vertical-align: middle;width:100px;}
#defLayout .l-layout-right .l-layout-header{background: none repeat scroll 0 0 #009bdb;}
