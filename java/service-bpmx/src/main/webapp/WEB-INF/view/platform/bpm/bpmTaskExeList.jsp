		...
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					...
					<li>	
						<span class="label" style="width:65px">创建时间:</span><input  name="Q_begincratetime_DL"  class="inputText datePicker" datetype="1" value="${param['Q_begincratetime_DL']}" />

						<span class="label label_line">_ </span><input  name="Q_endcratetime_DG" class="inputText datePicker"  datetype="2"  value="${param['Q_endcratetime_DG']}"/>
					</li>
