			...
			<display:column title="${checkAll}" media="html" style="width:30px;">
				<c:choose>
					<c:when test="${isSingle==false}">
						<input type="checkbox" class="pk" name="orgId" value="${sysOrgItem.orgId}#${sysOrgItem.orgPathname}">
					</c:when>
					<c:otherwise>
						<input type="radio" class="pk" name="orgId" value="${sysOrgItem.orgId}#${sysOrgItem.orgPathname}">
					</c:otherwise>
				</c:choose>
