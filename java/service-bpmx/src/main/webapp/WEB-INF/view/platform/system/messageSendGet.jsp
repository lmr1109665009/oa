...
<body>
			...
			<table class="table-detail" cellpadding="0" cellspacing="0"
				...
				<c:if test="${messageSend.canReply==1}">
					<tr>
						<th width="20%">回复信息：</th>
						<td colspan="3"><a
							href="${ctx}/platform/system/messageReply/list.ht?messageId=${messageSend.id}&userId=${messageSend.userId}">查看回复信息</a></td>
					</tr>
				</c:if>
			</table>
    ...
    <table class="table-detail" cellpadding="0" cellspacing="0"
  		...
  		<tr>
  			...
  			<td>
				<a
						href="${ctx}/platform/system/sysUser/get.ht?userId=\${obj.userId}&hasClose=true&canReturn=-1"
