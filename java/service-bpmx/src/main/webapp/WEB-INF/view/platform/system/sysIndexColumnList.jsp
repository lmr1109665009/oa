	...
	<div class="panel">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<ul class="row">									
						...
						</li><li><span class="label">栏目别名:</span><input type="text" name="Q_alias_SL"  class="inputText" value="${param['Q_alias_SL'] }" />
						</li><li><span class="label">是否刷新:</span>
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysIndexColumnList" id="sysIndexColumnItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:300px;" class="opsBtnb">
					<a href="edit.ht?id=${sysIndexColumnItem.id}" class="link edit">编辑</a>  | 
					<a onclick="previewTemplate('${sysIndexColumnItem.id}','${sysIndexColumnItem.name}');"  class="link detail">详情</a>  | 
					<a onclick="SysObjRightsUtil.setRights('${sysIndexColumnItem.id}','${objType}');"  class="link authorize">授权</a>  | 
