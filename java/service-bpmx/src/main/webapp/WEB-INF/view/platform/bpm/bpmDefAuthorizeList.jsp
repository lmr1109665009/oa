	...
	<div class="panel-top">	
			...
			<div class="panel-search">
				...
				<form id="searchForm" method="post" action="list.ht">	    
					<ul class="row">
						...
						<li><span class="label" style="width:70px">授权人员名称:</span><input type="text" name="Q_ownerName_SL"  class="inputText" value="${param['Q_ownerName_SL']}"/></li>
						
						<li><span class="label" style="width:70px">授权流程名称:</span><input type="text" name="Q_defName_SL"  class="inputText" value="${param['Q_defName_SL']}"/></li>
		...
		<div class="panel-body">
			    ...
			    <display:table name="bpmDefAuthorizeList" id="bpmDefAuthorizeItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
					...
					<display:column property="authorizeDesc" title="权限描述" style="width:10%" sortable="false" sortName="authorizeDesc" ></display:column>
					
					<display:column title="授权人员名称"  style="width:10%;">
					...
					<display:column title="流程名称"  style="width:40%;">
