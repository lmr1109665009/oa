	...
	<div>
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<a href="javascript:;" class="tipinfo tipinfotop"><span>编写SQL时，可以使用__PK__代替业务主键；<br>SQL中的别名，可以是字母下划线的组合，并且需要确保在当前记录中是唯一的。</span></a>
			</div>
		</div>
	</div>
			...
			<div class="panel-nav">
				<table cellpadding="0" cellspacing="0" border="0"  class="table-detail">
					...
					<tr>
						...
						<textarea hidden=true id="sql" name="sql">${sysWordTemplate.sql}</textarea>
						</td> 
					</tr>
					<tr class="formOption">
						<th>表:&nbsp;</th>
