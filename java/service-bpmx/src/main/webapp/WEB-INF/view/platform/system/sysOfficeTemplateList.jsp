		...
		<div class="panel-body">
			    ...
			    <display:table name="sysOfficeTemplateList" id="sysOfficeTemplateItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
					<display:column title="${checkAll}" media="html" style="width:30px;">
						  	...
						  	<input type="hidden" class="rtn" name="rtn" value="${sysOfficeTemplateItem.id},${ sysOfficeTemplateItem.subject},${sysOfficeTemplateItem.fileid}">
					</display:column>
					...
					<display:column title="管理" media="html"  style="width:250px;text-align:center">
                        ...
                        <a href="<c:url value="editRight.ht"><c:param name="id" value="${sysOfficeTemplateItem.id}"></c:param><c:param name="name" value="${sysOfficeTemplateItem.subject}"></c:param> </c:url>" class="link detail">权限设置</a>
					</display:column>
				</display:table>
