...
<head>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			var itemId=$("input[name=itemId]")[0].value;
			if(type==2){
				var aryTypeId = [];
			...
			var param={type:type,approvalItem:approvalItem,flowTypeId:flowTypeId,defKey:defKey,itemId:itemId}
			...
			$.post(url,param,function(msg){
				...
				if(obj.isSuccess()){
					...
					$.ligerDialog.err("提示信息","常用语保存失败!",obj.getMessage());
				}
			});
		}
							...
							<c:choose>
								<c:when test="${isAdmin==0}">
									<div class="reminder-div-all" title="个人常用语设置" >
										...
										<input type="hidden" id="itemId" name="itemId" value="${taskApprovalItems.itemId}">
								...
								<c:when test="${isAdmin==1}">
									...
									<input type="hidden" name="type" id="type" value="1"/>
										<input type="hidden" name="itemId" value="${taskApprovalItems.itemId}">
										<div class="panel-detail">
											<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
												<tr>
													<th width="20%">常用语: </th>
											    ...
											    <tr id="trFlowType">
													...
													<td>
														<div id="flowTypeDiv">
															...
															<c:choose>
																<c:when test="${globalType!=null}">
																<input type="hidden" id="refFlowKey" name="refFlowKey" value="{&quot;${globalType.typeId}&quot;:&quot;${globalType.typeName}&quot;"/>
																<span id="flowTypeArray">
																	<span id="type_${globalType.typeId}" typeid="${globalType.typeId}">${globalType.typeName}<a href="javascript:void(0);" onclick="delType(&quot;${globalType.typeId}&quot;)">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;</span>
																	</span>
																	</c:when>
																<c:otherwise>
								    	...
								    	<div class="panel-detail">
										    <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
										    	<tr>
										    		...
										    		<td >
														<c:choose>
															<c:when test="${bpmDefinition!=null}">
																<input type="hidden" id="refDefKey" name="refDefKey" value="{&quot;${bpmDefinition.defKey}&quot;:&quot;${bpmDefinition.subject}&quot;}">
																<span id="refDefArray">
																<span id="ref_${bpmDefinition.defKey}" referkey="${bpmDefinition.defKey}">${bpmDefinition.subject}<a href="javascript:void(0);" onclick="delRefer(&quot;${bpmDefinition.defKey}&quot;)">删除</a>&nbsp;&nbsp;&nbsp;</span>
																</span>
															</c:when>
															<c:otherwise>
