...
<div position="center">
			...
			<div class="panel">
				...
				<div class="panel-body">
				    	<div class="panel-data" style="overflow: auto;height: 340px">
						<form id="sysUserParamForm" method="post" action="${ctx }/platform/system/sysUserParam/saveByUserId.ht">
							...
							<table class="table-grid" width="90%">
									<tr>
									    <td>人员类型:</td>
										<td align="left">
								            <input type="radio" name="userType" value="start" memo="发起人" <c:if test="${empty userType|| userType eq 'start'}">checked="checked"</c:if> />
										           发起人
