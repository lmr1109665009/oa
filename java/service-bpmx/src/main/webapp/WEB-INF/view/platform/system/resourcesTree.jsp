  ...
  //改变属性
	...
	function loadTree(){
		...
		$.post(url,params,function(result){
			//result.icon = result.iconfont;
			resourcesTree=$.fn.zTree.init($("#resourcesTree"), setting,getRootNodes(result));	
...
<style type="text/css">
	html,body{ padding:0px; margin:0;height:100%;overflow: hidden;} 
</style>
</head>
<body >
<div id="layout" >
	<div position="left" title="资源管理" style="text-align: left;" >
		<div style="width:100%;">
		        <select id="subSystem" style="width:99.8% !important;display: none;">  
