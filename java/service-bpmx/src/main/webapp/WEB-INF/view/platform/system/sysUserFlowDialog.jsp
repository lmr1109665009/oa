...
.l-accordion-content .ztree { height:270px !important;}
.table-detail select{width:140px;}
/*修正复选框的位置垂直居中*/
#leftMemu .l-accordion-header input[type="checkbox"],.l-layout-header-inner input[type="checkbox"]{
...
<body>
	<div id="defLayout">
		...
		<div position="right" title="<span><a onclick='javascript:dellAll();' class='link del'>清空 </a><input type='hidden' class='quick-find' title='查找' style='width:60px;' /></span>"
			style="height:91.5%;overflow:auto;">
		...
		<div position="bottom"  class="bottom" >
			...
			<a href="javascript:;" class="button"  onclick="selectUser()" ><span class="icon ok"></span><span > 确定</span></a>
		</div>
	</div>
</body>
</html>
