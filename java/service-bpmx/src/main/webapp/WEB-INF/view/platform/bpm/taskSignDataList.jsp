					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<ul class="row">
												...
												<li><span class="label">投票时间:</span> <input  name="Q_beginvoteTime_DL"  class="inputText date" value="${param['Q_beginvoteTime_DL']}"/>
												<span class="label label_line">_ </span><input  name="Q_endvoteTime_GL" class="inputText date" value="${param['Q_endvoteTime_GL']}"/></li>
					...
					<div class="panel-data">
					    ...
					    <display:table name="taskSignDataList" id="taskSignDataItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
								...
								<a href="get.ht?dataId=${taskSignDataItem.dataId}" class="link detail">详情</a>  | 
							</display:column>
						</display:table>
