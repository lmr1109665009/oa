...
<link rel="stylesheet" type="text/css"
	href="${ctx}/styles/common/css/fullcalendar/fullcalendar.min.css"></link>
...
<script type="text/javascript">
	...
	var calendarObj;
	$(function() {
		var queryDataUrl = __ctx + "/platform/system/sysPlan/listByParticipantAndMonth.ht";
		var openPlanUrl = __ctx + "/platform/system/sysPlan/participantToExchange.ht?type=participant";
		var queryParams={
	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">参与的日程</span>
			</div>
