...
//var win = window.parent.frameElement.dialog;
	$(function(){
		$("#defLayout").ligerLayout({ topHeight: 85, bottomHeight:60,allowTopResize:false,allowBottomResize:false});
        var height = $(".l-layout-center").height();
        $("#defLayout .l-layout-center .panel-table").height(height-75)
	...
	<style>
		.l-panel-bbar-inner{ bottom: 55px;}
		.panel-table .table-grid.table-list>tbody{ padding-bottom: 55px;}
	</style>
