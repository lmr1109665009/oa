	...
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysPlanList" id="sysPlan" requestURI="${ctx}/platform/system/sysPlan/underList.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column  title="任务名称" sortable="true" sortName="TASKNAME">${sysPlan.taskName}
				</display:column>
				...
				<display:column title="管理" media="html" style="width:150px;"  class="opsBtnb"> <!--  class="rowOps" -->
					<a href="${ctx}/platform/system/sysPlan/subscribeGet.ht?type=subscribe&id=${sysPlan.id}&subscribeId=${sysPlan.subscribeId}&queryUserId=${queryUserId}" class="link detail">详情</a>  | 
					<c:choose>
