		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link update update-hide" id="btnUpd" action="edit.ht">修改</a></div>
					-->
					<div class="l-bar-separator"></div>
				...
				<form id="searchForm" method="post" action="list.ht">
					<ul class="row">
						...
						<select name="Q_state_SN" value="${param['Q_state_SN']}">
							...
							<li><span class="label">发送时间:</span><input  name="Q_beginSendTime_DL"  class="inputText date" value="${param['Q_beginSendTime_DL']}"/>
							<span class="label label_line">_ </span><input  name="Q_endSendTime_DG" class="inputText date" value="${param['Q_endSendTime_DG']}"/></li>
		...
		<div class="panel-body">
		    ...
		    <display:table name="messageLogList" id="messageLogItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
				...
				<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
					...
					-->
					<a href="get.ht?id=${messageLogItem.id}" class="link detail">详情</a>  | 
