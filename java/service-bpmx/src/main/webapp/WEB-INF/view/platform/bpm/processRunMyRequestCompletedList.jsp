	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="myRequestCompletedList.ht">
						<ul class="row">
						...
						<li>
							...
							<select name="Q_flag_SN">
								...
								<option value="1" <c:if test="${param['Q_flag_SN'] == '1'}">selected</c:if>>我的请求</option>
								<option value="2" <c:if test="${param['Q_flag_SN'] == '2'}">selected</c:if>>我的办结</option>
							</select>
						</li>
						<li>
		...
		<div class="panel-body">
			<display:table name="processRunList" id="processRunItem" requestURI="myRequestCompletedList.ht" sort="external" cellpadding="1"
				...
				<display:column titleKey="执行人" >
						<f:userName userId="${processRunItem.assignee}" taskId="${processRunItem.taskId}"/>
				</display:column>	
