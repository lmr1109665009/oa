	...
	<div class="panel">
		...
		<div class="panel-body">
	    	<display:table name="bpmProCopytoList" id="bpmProCopytoItem" requestURI="getCopyUserByInstId.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				<display:column property="ccUname" title="接收人" style="width:14%">
					<c:out value="${bpmProCopytoItem.ccUname}"></c:out>
				</display:column>
				<display:column property="posName" title="岗位"  style="width:14%">
					<c:out value="${bpmProCopytoItem.posName}"></c:out>
				</display:column>
				<display:column property="orgName" title="组织"  style="width:14%">
					<c:out value="${bpmProCopytoItem.orgName}"></c:out>
				</display:column>
			
				<display:column title="是否已读" style="width:60px; width:14%" sortable="true" sortName="IS_READED">
					<c:choose>
				...
				<display:column property="creator" title="发送人"  style="width:14%">
					<c:out value="${bpmProCopytoItem.creator}"></c:out>
				</display:column>
				<display:column  title="抄送时间 "  style="width:14%">
					<fmt:formatDate value="${bpmProCopytoItem.ccTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</display:column>
				<display:column title="类型" style="width:14%;" sortable="true" sortName="CP_TYPE">
					<c:choose>
