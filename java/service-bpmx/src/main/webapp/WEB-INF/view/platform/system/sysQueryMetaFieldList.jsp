		...
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht?__FILTERKEY__=${busQueryRule.filterKey}&__IS_QUERY__=0">
					<ul class="row">
						<li><span class="label">SQLID:</span><input type="text" name="Q_sqlId_SL"  class="inputText" />
						</li>
						<li><span class="label">字段名:</span><input type="text" name="Q_name_SL"  class="inputText" />
						</li>
						<li><span class="label">实际字段名:</span><input type="text" name="Q_fieldName_SL"  class="inputText" />
						</li>
						<li><span class="label">字段备注:</span><input type="text" name="Q_fieldDesc_SL"  class="inputText" />
						</li>
						<li><span class="label">是否可见:</span><input type="text" name="Q_isShow_SN"  class="inputText" />
						</li>
						<li><span class="label">是否搜索:</span><input type="text" name="Q_isSearch_SN"  class="inputText" />
						</li>
						<li><span class="label">控件类型:</span><input type="text" name="Q_controlType_SN"  class="inputText" />
						</li>
						<li><span class="label">数据类型:</span><input type="text" name="Q_dataType_SL"  class="inputText" />
						</li>
						<li><span class="label">是否衍生列:</span><input type="text" name="Q_isVirtual_SN"  class="inputText" />
						</li>
						<li><span class="label">衍生列来自列:</span><input type="text" name="Q_virtualFrom_SL"  class="inputText" />
						</li>
						<li><span class="label">来自类型:</span><input type="text" name="Q_resultFromType_SL"  class="inputText" />
						</li>
						<li><span class="label">衍生列配置:</span><input type="text" name="Q_resultFrom_SL"  class="inputText" />
					    </li>
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysQueryMetaFieldList" id="sysQueryMetaFieldItem" requestURI="list.ht?__FILTERKEY__=${busQueryRule.filterKey}&__FILTER_FLAG__=${busQueryRule.filterFlag}" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
					...
					<a href="get.ht?id=${sysQueryMetaFieldItem.id}" class="link detail">详情</a>  | 
