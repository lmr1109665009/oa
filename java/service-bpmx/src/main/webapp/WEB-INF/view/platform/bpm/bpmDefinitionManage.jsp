      	...
      	<div id="defLayout" class="panel-top">
            <div position="left" title="流程分类管理" style="overflow: auto;float:left;width:100%">
            	<div class="tree-toolbar">
					<span class="toolBar">
						<div class="group"><a class="link reload" id="treeFresh" title="刷新" href="javascript:globalType.loadGlobalTree();" ><span></span></a></div>
						<div class="l-bar-separator"></div>
						<div class="group"><a class="link expand" id="treeExpandAll" title="展开" href="javascript:treeExpandAll(true)" ><span></span></a></div>
						<div class="l-bar-separator"></div>
						<div class="group"><a class="link collapse" id="treeCollapseAll" title="收起" href="javascript:treeExpandAll(false)" ><span></span></a></div>
					</span>
