			...
			<div class="hide-panel">
					...
					<div class="panel-top">
						...
						<div class="panel-toolbar">
							<div class="toolBar">
								...
								<div class="l-bar-separator"></div>
								<div class="group">
									<f:a alias="delRole" css="link del"  action="del.ht"><span></span>批量删除</f:a>
								</div>
								<div class="l-bar-separator"></div>
								<div class="group">
				...
				<div class="panel-body">
					    ...
					    <display:table name="sysRoleList" id="sysRoleItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
							...
							<display:column title="管理" media="html"  style="width:30%" class="opsBtnb">
								<c:choose>
								...
								<f:a alias="roleDetail" css="link detail" href="get.ht?roleId=${sysRoleItem.roleId}">详情</f:a> |
