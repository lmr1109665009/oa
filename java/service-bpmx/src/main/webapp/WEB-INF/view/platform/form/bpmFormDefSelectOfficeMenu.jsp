    ...
    $('input:checkbox').each(function(){
		  ...
		  switch(key){
		  	...
		  	case "lhRight":
				...
				break;
		  	case "showHideLhRight":
		  		if(data.showHideLhRight=='y'){
					me.attr("checked",true);
				}
				break;
		  	case "originRight":
		  		if(data.originRight=='y'){
					me.attr("checked",true);
				}
				break;
		  	case "blhRight":
	...
	$('input:checkbox').each(function(){
		  ...
		  switch(key){
		  	...
		  	case "blhRight":
				...
				break;
		  	case "showHideLhRight":
				data.showHideLhRight=value;
				break;
		  	case "originRight":
				data.originRight=value;
				break;
		  	case "qchjRight":
		...
		<div class="panel-detail">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<th width=100>屏蔽显示留痕:</td>
					<td><input type="checkbox" id="showHideLhRight" name="menuRight" value="showHideLhRight"/></td>
				</tr>
				<c:if test="aa!=null">
					<tr>
						<th width=100>留痕:</td>
						...
						<th width=100>原始版本:</td>
						<td><input type="checkbox" id="originRight" name="menuRight" value="originRight"/></td>
					</tr>
					<tr>
