...
<script type="text/javascript">
	...
	function copyTable(tableId){
		...
		ImportExportXml.showModalDialog({url:url,width:750,height:450,scroll:1,title:"复制自定义表"});
	}
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="l-bar-separator"></div>
					<div class="group"><f:a alias="delForm" css="link del" action="delByTableId.ht" showNoRight="false" ><span></span>批量删除</f:a></div>
					<div class="l-bar-separator"></div>
					<div class="group">
			 ...
			 <div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					...
					<ul class="row">
						...
						<li><span class="label" style="text-align:left;width:20px">表别名:</span>
							<input type="text" 
			...
			<display:table name="bpmFormTableList" id="bpmFormTableItem"
				...
				<display:column property="tableDesc" title="表名" sortable="true" sortName="tableDesc" style="text-align:center"></display:column>
				<display:column property="tableName" title="表别名" sortable="true" sortName="tableName" style="text-align:center"></display:column>
				<display:column property="categoryName" title="表分类" sortable="false" style="text-align:center"></display:column>
				<display:column title="属性" style="text-align:center">
					<c:choose>
				...
				<display:column title="生成方式" style="text-align:center">
					<c:choose>
				...
				<display:column title="管理" media="html" class="opsBtnb" style="width:150px;">
					...
					<c:choose>
						 <c:when test="${bpmFormTableItem.isExternal == 0 }">
							<c:if test="${bpmFormTableItem.genByForm==0}">
								...
								<c:if test="${ bpmFormTableItem.isPublished==1}">
					  ...
					  <a href="get.ht?tableId=${bpmFormTableItem.tableId}" class="link detail">详情</a>  | 
					  ...
					  <a href="delByTableId.ht?tableId=${bpmFormTableItem.tableId}" class="link del">删除</a>
				</display:column>
			</display:table>
