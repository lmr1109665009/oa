		...
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht?orgId=${orgId}">
					<ul class="row">
						<li><span class="label">组织ID:</span><input type="text" name="Q_orgid_SL"  class="inputText" /></li>
						<li><span class="label">岗位ID:</span><input type="text" name="Q_posid_SL"  class="inputText" /></li>
						<li><span class="label">用户ID:</span><input type="text" name="Q_userid_SL"  class="inputText" /></li>
						<li><span class="label">是否主岗位:</span><input type="text" name="Q_isprimary_SL"  class="inputText" /></li>
						<li><span class="label">是否负责人:</span><input type="text" name="Q_ischarge_SL"  class="inputText" /></li>
						<li><span class="label">是否删除:</span><input type="text" name="Q_isdelete_SL"  class="inputText" /></li>
		...
		<div class="panel-body">
		    ...
		    <display:table name="userPositionList" id="userPositionItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
					...
					<a href="get.ht?userPosId=${userPositionItem.userPosId}" class="link detail">详情</a>  | 
