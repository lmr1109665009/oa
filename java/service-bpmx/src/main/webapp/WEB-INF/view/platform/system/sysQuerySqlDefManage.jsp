...
<style type="text/css">
	...
	<script type="text/javascript">
		...
		function onClick(treeNode){
			var url="${ctx}/platform/system/sysQuerySqlDef/list.ht";
...
<body>
   	<div id="defLayout" >
         <div position="left" title="自定义sql管理" style="overflow: auto;float:left;width:100%">
         ...
         <div position="center">
        	<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/system/sysQuerySqlDef/list.ht"></iframe>
         </div>
     </div>
</body>
</html>
