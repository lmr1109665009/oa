	...
	<div position="center" >
		<div class="panel">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="flowTypeSelector.ht">
					<input type="hidden" name="defId" id="bpmDefId" value="${defId }"/>
					<ul class="row">
						<li><span class="label">分类名称:</span><input type="text" name="Q_typeName_SL"  class="inputText" style="width:120px;"/>
					</li></ul>
				</form>
			</div>
