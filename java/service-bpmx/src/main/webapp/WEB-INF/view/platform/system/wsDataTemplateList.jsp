	...
	<div class="panel">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<ul class="row">
						...
						<li><span class="label">别名:</span>
						<select name="Q_serviceId_L" class="select">
		...
		<div class="panel-body">
		    ...
		    <display:table name="wsDataTemplateList" id="wsDataTemplateItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column titleKey="管理" media="html" style="width:150px" class="opsBtnb">
					<a href="edit.ht?id=${wsDataTemplateItem.id}" class="link edit">编辑</a> |				
					<a href="get.ht?id=${wsDataTemplateItem.id}" class="link detail">详情</a>  | 				
