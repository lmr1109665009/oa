		...
		<div class="panel-body">
		    ...
		    <display:table name="bpmProTransToList" id="bpmProTransToItem" requestURI="mattersList.ht" cellpadding="1" cellspacing="1"  class="table-grid">
				...
				<display:column  titleKey="请求标题" sortable="true" sortName="subject">
					${f:subString(bpmProTransToItem.subject)}
				</display:column>
				...
				<display:column titleKey="管理" media="html" class="opsBtnb">
				    <a name="processDetail" onclick="showDetail(this)" href="#${bpmProTransToItem.id}"  action="${ctx}/platform/bpm/processRun/info.ht?link=1&runId=${bpmProTransToItem.runId}" title='${bpmProTransToItem.subject}' class="link detail">详情</a> | 
