...
<head>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#tab").ligerTab();
            $("#fieldTree").height($(".l-layout-left").height()-50);
	...
	<div class="panel">
		<div class="panel-top">
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group grouptop">标题：<input type="text" ng-model="prop.title" disabled="disabled" style="width: 200px" validate="{required:true,maxlength:64}" /></div>
					...
					<div class="group grouptop">列数：<input type="text" ng-model="param.columnNum" style="width: 50px" validate="{required:true,maxlength:64}" /></div>
		...
		<div id="defLayout" >
			<div position="left" title="表字段" style="overflow: auto;float:left;width:100%">
				<ul id="fieldTree" class="ztree" style="overflow:auto;height: 100%"></ul>
			</div>
