			...
			<div class="hide-panel">
				...
				<div class="panel-body">
				    ...
				    <display:table name="bpmFormRuleList" id="bpmFormRuleItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
						...
						<display:column property="name" title="规则名" style="text-align:center" ></display:column>
						<display:column property="rule" title="规则" style="text-align:center"></display:column>
						<display:column property="tipInfo" title="错误提示信息" style="text-align:center"></display:column>
						<display:column property="memo" title="描述" style="text-align:center"></display:column>
						<display:column title="管理" media="html" style="width:150px;text-align:center">
							<a href="edit.ht?id=${bpmFormRuleItem.id}" class="link edit">编辑</a> | 
							<a href="get.ht?id=${bpmFormRuleItem.id}" class="link detail">详情</a>  | 
