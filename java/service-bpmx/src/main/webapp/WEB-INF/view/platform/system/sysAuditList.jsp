					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<ul class="row">
										...
										<li><span class="label">执行时间:</span><input  name="Q_beginexeTime_DL"  class="inputText date" value="${param['Q_beginexeTime_DL']}"/>
										<span class="label label_line">_ </span><input  name="Q_endexeTime_DG" class="inputText date" value="${param['Q_endexeTime_DG']}"/></li>
				...
				<div class="panel-body">
					    ...
					    <display:table name="sysAuditList" id="sysAuditItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
								<a href="get.ht?auditId=${sysAuditItem.auditId}" class="link detail">详情</a>  | 
