...
<script type="text/javascript">
		...
		$(function() {
			...
			$('#orgTree').height($(window).height()*0.9 -120)
...
<body>
	<div id="defLayout">
		<div  position="left" title="组织树" style="float: left;width: 100% !important;height:100%;">
			 <div style="width:100%;">
		...
		<div position="center">
			...
			<iframe id="posFrame" name="posFrame" height="100%" width="100%"  
	 ...
	 <div position="bottom"  class="bottom" style='margin-top:10px;'>
		...
		<a href='#' class='button' style='margin-left:10px;'  onclick="dialog.close()"><span class="icon cancel"></span><span>取消</span></a>
		 <a href='#' class='button'  onclick="selectPosition()" style="margin-right:10px;"><span class="icon ok"></span><span>确定</span></a>
	</div>
