...
<script type="text/javascript">
	...
	function save() {
		...
		var url = "saveCopy.ht";
		var para = "formDefId=" + formDefId +  "&formKey=" + formKey + "&formName=" + formName
	...
	<div class="panel-body">
		<form id="formCopy" name="formCopy">
			...
			<table class="table-detail" cellpadding="0" cellspacing="0"
				...
				<tr>
					<th width="15%">原表单别名:</th>
					<td><input type="text" class="inputText" disabled="disabled" value="${bpmFormDef.formKey}" /></td>
					<th width="15%">新表单别名:</th>
					<td><input type="text" id="formKey" name="formKey" validate="{required:true}" class="inputText" /></td>
				</tr>
				<tr>
