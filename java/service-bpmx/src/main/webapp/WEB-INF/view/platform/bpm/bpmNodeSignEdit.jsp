												...
												<td>
													...
													<c:choose>
														<c:when test="${bpmNodePrivilege.usertype==0}">
															流程发起人<textarea name="cmpNames" style="width:500px;float: left;display:none;" rows="3" class="textarea">${bpmNodePrivilege.cmpnames}</textarea>
															<a class="button" onclick="selectCmp(this);" style="display:none;"><span>选择...</span></a>
														</c:when>
														<c:when test="${bpmNodePrivilege.usertype==9}">
															与发起人相同部门<textarea name="cmpNames" style="width:500px;float: left;display:none;" rows="3" class="textarea">${bpmNodePrivilege.cmpnames}</textarea>
															<a class="button" onclick="selectCmp(this);" style="display:none;"><span>选择...</span></a>
														</c:when>
														<c:when test="${bpmNodePrivilege.usertype==11}">
															发起人的直属领导(组织)<textarea name="cmpNames" style="width:500px;float: left;display:none;" rows="3" class="textarea">${bpmNodePrivilege.cmpnames}</textarea>
															<a class="button" onclick="selectCmp(this);" style="display:none;"><span>选择...</span></a>
														</c:when>
														<c:when test="${bpmNodePrivilege.usertype==13}">
															上个任务执行人的直属领导(组织)<textarea name="cmpNames" style="width:500px;float: left;display:none;" rows="3" class="textarea">${bpmNodePrivilege.cmpnames}</textarea>
															<a class="button" onclick="selectCmp(this);" style="display:none;"><span>选择...</span></a>
														</c:when>
														<c:when test="${bpmNodePrivilege.usertype==14}">
															发起人的领导<textarea name="cmpNames" style="width:500px;float: left;display:none;" rows="3" class="textarea">${bpmNodePrivilege.cmpnames}</textarea>
															<a class="button" onclick="selectCmp(this);" style="display:none;"><span>选择...</span></a>
														</c:when>
														<c:when test="${bpmNodePrivilege.usertype==15}">
															上个任务执行人的领导<textarea name="cmpNames" style="width:500px;float: left;display:none;" rows="3" class="textarea">${bpmNodePrivilege.cmpnames}</textarea>
															<a class="button" onclick="selectCmp(this);" style="display:none;"><span>选择...</span></a>
														</c:when>
														
														<c:otherwise>
															<textarea name="cmpNames" readonly="readonly" style="width:500px;float: left;visibility:visible" rows="2" class="textarea">${bpmNodePrivilege.cmpnames}</textarea>
