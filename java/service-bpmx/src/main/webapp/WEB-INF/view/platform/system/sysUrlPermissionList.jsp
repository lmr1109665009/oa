...
<div class="panel">
	<div class="panel-toolbar">
		<div class="toolBar">
				...
				<div class="l-bar-separator"></div>
				<div class="group"><a href="javascript:;" class="link del"  action="del.ht"><span></span>批量删除</a></div>
				<div class="l-bar-separator"></div>
	...
	<div class="panel-search">
		<form id="searchForm" method="post" action="list.ht">
			<ul class="row"><li>
				...
				</li><li><span class="label">是否启用:</span>
				</li><li><select name="Q_enable_L" class="select" value="${param['Q_enable_L']}">
	...
	<div class="panel-body">
		    ...
		    <display:table name="sysUrlPermissionList" id="sysUrlPermissionItems" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
				...
				<display:column title="管理" media="html" style="width:150px" class="opsBtnb">
					...
					<a href="get.ht?id=${sysUrlPermissionItems.id}" class="link edit">详情</a> |
