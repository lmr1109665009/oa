	...
	<div class="hide-panel">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="accordingMattersList.ht">
					<ul class="row">
						...
						<li><span class="label">事项名称:</span><input type="text" name="Q_subject_SUPL"  class="inputText"   value="${param['Q_subject_SUPL']}"/></li>
						...
						<li><span class="label">发 起 人:</span>
						...
						<input type="button" value="选择..." onclick="selectUser('creatorId','creator');"></li>
						<div class="row_date">
						<li><span class="label">创建时间:</span><input  name="Q_begincratetime_DL"  class="inputText datePicker" datetype="1" value="${param['Q_begincratetime_DL']}" /></li>
						<li><span class="label label_line">_ </span><input  name="Q_endcratetime_DG" class="inputText datePicker"  datetype="2"  value="${param['Q_endcratetime_DG']}"/></li>
						</div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="bpmTaskExeList" id="bpmTaskExeItem" requestURI="accordingMattersList.ht" cellpadding="1" cellspacing="1"  class="table-grid">
				...
				<display:column  titleKey="事项名称" sortable="true" sortName="subject">
					${f:subString(bpmTaskExeItem.subject)}
				</display:column>
				...
				<display:column titleKey="发起人" sortable="true" sortName="creator" style="text-align:center;">
				...
				<a name="processDetail" onclick="showDetail(this)" href="#${bpmTaskExeItem.id}"  action="${ctx}/platform/bpm/processRun/info.ht?link=1&runId=${bpmTaskExeItem.runId}" title='${bpmTaskExeItem.subject}' class="link detail">详情</a> | 
