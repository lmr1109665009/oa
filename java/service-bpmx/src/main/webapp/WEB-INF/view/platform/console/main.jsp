...
<head>
	...
	<f:link href="tree/zTreeStyleMain.css"></f:link>
    ...
    <script type="text/javascript">
            ...
            $(function (){
                //布局
                mian_layout_ =$("#layoutMain").ligerLayout({ leftWidth: 220,allowLeftCollapse:false, allowLeftResize: false }); 
				//取得layout的高度
                var height = $(".l-layout-center").height();
                var width = $(".l-layout-center").width();
                $("#leftTree").height(height-0);
                $("#framecenterbox").addClass("boxshadow");
                $("div.l-layout-collapse-left,div.l-layout-left").css("margin","0px 0 0 0");
                //Tab
                ...
                $("#menuPanel").delegate("a.menuItem", "click", function(){
                    ...
                    $(".index_top").removeClass("closelogo");
              		$("#layoutMain").removeClass("menu-opened");
              		$("#layoutMain .l-layout-center").css({"left":"223px","width":($("#layoutMain").width()-$("#layoutMain .l-layout-left").width())});
              		var width = $(".l-layout-center").width();
                    var height = $(".l-layout-center").height();
                ...
                $(window).resize(function(){
                    if($(".index_top").hasClass("closelogo"))
                    	{$("#layoutMain .l-layout-center").css({"left":"0","width":"100%"});}
              		else
              			{$("#layoutMain .l-layout-center").css({"left":"223px","width":($("#layoutMain").width()-$("#layoutMain .l-layout-left").width())});
              			}
                    var width = $(".l-layout-center").width();
             ...
             function addToTab(url){
          	...
          	function menuType() {
                ...
                $("iframe").width(width-30);
          			...
          			{
          			$(".index_top").addClass("closelogo");
          			$("#layoutMain").addClass("menu-opened");
              		$("#layoutMain .l-layout-center").css({"left":"0","width":"100%"});var height = $(".l-layout-center").height();
                    var width = $(".l-layout-center").width();
                    var height = $(".l-layout-center").height();
                    $("iframe").height(height-30);
                    $("iframe").width(width-30);
...
<style type="text/css"> 
	...
	#top a{color:white;}
	.closelogo .left_logo{display: none;}
	.closelogo .index_menu{left:0}
	.closelogo .nav_arr{background:white url('${ctx}/styles/${skinStyle}/images/other/arr-r1.png') no-repeat center;}
  	.menu-opened .l-layout-left {
	        display:none;
	    }
	#framecenter iframe{
	}    
	.l-layout-center{background:#EEF2F3;}
    .boxshadow{box-shadow:0 0 8px #ddd;position: absolute;top:15px;bottom:15px;left:15px;right:15px;}
 </style>
</head>
