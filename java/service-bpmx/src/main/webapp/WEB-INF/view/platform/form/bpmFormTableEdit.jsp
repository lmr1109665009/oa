...
<script type="text/javascript">
	...
	function handSave(generate){
			...
			var tableJson={tableName:name,tableDesc:comment,isMain:isMain,mainTableId:mainTableId, categoryId:categoryId};
			...
			//
			$.post("saveTable.ht",{table:tableJson,fields:fieldJson,generator:generate,categoryId:categoryId},showResponse);
	}
	...
	function showResponse(data){
		...
		if(obj.isSuccess()){//成功
			$.ligerDialog.confirmEx("操作成功,继续操作吗?","提示",function(rtn){
				if(!rtn){
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a onclick="clickAddRow()" class="link add"><span></span>添加字段</a></div>
					<div class="l-bar-separator"></div>
		...
		<form id="bpmTableForm" method="post" action="saveTable.ht">
			<div class="panel-detail">
				...
				<table id="tableColumnItem" class="table-grid table-list" id="0" cellpadding="1" cellspacing="1" style="margin-top: 3px;">
			   		<thead>
						<%--<th width="5%"><input id="selectAll" type="checkbox" value="0"/> 全选</th>--%>
			   			<th width="10%">字段名称</th>
			   			<th width="20%">字段别名</th>
			    		<th width="10%">类型</th>
			    		<%--<th width="10%">必填</th>--%>
