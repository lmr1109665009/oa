		...
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht?Q_objType_S=${param.Q_objType_S}&rtnUrl=${param.rtnUrl}">
					<ul class="row">
						<li><span class="label">操作人:</span><input type="text" name="Q_operator_SL"  class="inputText" /></li>
						<li><span class="label">名称:</span><input type="text" name="Q_name_SL"  class="inputText" /></li>
						<li><span class="label">创建时间:</span> <input  name="Q_begincreateTime_DL"  class="inputText date" />
						<span class="label label_line">_ </span><input  name="Q_endcreateTime_DG" class="inputText date" /></li>
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysObjLogList" id="sysObjLogItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
					<a href="get.ht?id=${sysObjLogItem.id}" class="link detail">详情</a>  | 
