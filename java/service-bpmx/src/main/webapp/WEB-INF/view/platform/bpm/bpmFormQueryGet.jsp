...
<script type="text/javascript">
	...
	function getQueryData(){
		...
		var data = [];
		$("#queryCondition td").each(function(){
			var tr = $(this);				
	...
	function help(){
			...
			html.push(alias);
			html.push('",page:1,pagesize:10,querydata:<span class="brown">querydata</span>};<br/><span class="brown">isSync</span>:是否同步,isSync=true,表示为同步,可以省略，省略为异步。</td></tr>');			
			html.push('<tr><th>调用的方法:</th><td>');
			html.push('DoQuery(<span class="brown">condition</span>');
			html.push(',function(<span class="brown">data</span>){},isSync);<br />该方法定义在<span class="green">${ctx}/js/hotent/platform/form/CommonDialog.js</span>中');
			html.push('</td></tr>');
...
<body>
	<div class="panel">	
		...
		<div id="resultDiv" style="padding:10px;">			
		</div>
	</div>
</body>
</html>
