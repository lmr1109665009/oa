	...
	<script type="text/javascript">
		...
		function showResponse(responseText) {
			...
			if (obj.isSuccess()) {//成功
				...
				$.ligerDialog.err("提示信息","流程转发保存失败!",obj.getMessage());
		...
		function chooseUser(){
			...
			var aryNewId=[];
			var aryNewName=[];
			UserDialog({selectUserIds:userIds, selectUserNames:userNames,
                callback:function(userId,names){
				if(userId=="") {
					clearUser();
					return;
				};
...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" id="dataFormSave" href="javascript:;"><span></span>转发</a></div>
			...
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td>
						...
						<br>
						<a class="link users" id="btnSelect" href="javascript:;" onclick="chooseUser();">选择</a>
