...
<script type="text/javascript">
	...
	function loadTree(selid,selid2) {
		var setting = {
				data: {
					key : {
		    ...
		    if(selid2==2){
		    	...
		    	var url="${ctx}/platform/system/sysOrg/getTreeData.ht?demId="+selid+"&type="+type+"&typeVal="+typeVal;
		    	var getTreeDataArr=[];		    		//获取所有内容
		    		  function getTreeDataList(selid,url,n){
		    			    $.ajax({
		    			      type: "get",
		    			      async: false,
		    			      url: url,
		    		  ...
		    		  getTreeDataList(selid,url,1);
		    		  getTreeDataList(selid,getTreeDataListUrl,2);
...
// 					setIcon(node);
	...
	function zTreeOnLeftClick(event, treeId, treeNode) {
		...
		$("#viewFrame").attr("src", __ctx+"/platform/system/sysUserOrg/userList.ht?recursion=1&orgId=" + orgId);
	};
	...
	function importOrg(){
		var conf={};				
		var url=__ctx + "/platform/system/sysOrg/importDialog.ht";
		conf.url=url;
		var dialogWidth=600;
...
<body>
	...
	<div id="layout" style="bottom: 1; top: 1">
		<div position="left" title="组织机构管理" id="rogTree"
			...
			<div class="tree-toolbar" id="pToolbar">
				<div class="toolBar"
					...
					<div class="group" >
						<a class="link reload" id="treeReFresh" title="刷新"></a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group" >
						<a class="link expand" id="treeExpand"  title="展开"></a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group" >
						<a class="link collapse" id="treeCollapse" title="收起"></a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group" >
						<a class="link search" id="treeSearch" title="组织树搜索"></a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group">
						<a class="link import" id="importBtn" title="组织架构导入"></a>
					</div>
				</div>
			</div>
		...
		<div position="center" id="orgView" style="height: 100%;">
			<div class="l-layout-header" style="display: none;">组织架构信息</div>
