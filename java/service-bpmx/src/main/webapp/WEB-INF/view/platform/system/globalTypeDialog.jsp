...
function getFullSpell(typeName,suffix){
	if(!suffix&&$("#nodeKey").val()!="") return;
...
function showResult(responseText){
	...
	if(!obj.isSuccess()) {
        console.log(obj);
        if (obj.data.cause=="key_exist"){
            keyCounter++;
            getFullSpell($("#typeName").val(),keyCounter);
				...
				<div class="panel-detail">
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								...
								<td>
									<input type="text" readonly id="ecodes" name="ecodes" value="${globalType.ecodes }" class="inputText"/>
									<input type="hidden" id="enterpriseName" name="enterprises" value="${enterprises}">
