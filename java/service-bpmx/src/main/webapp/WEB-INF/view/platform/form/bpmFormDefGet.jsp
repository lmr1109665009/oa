			...
			<%--<c:if test="${canReturn==0}">
				<div class="panel-toolbar">
					<div class="toolBar">
						...
						<div class="group">
							<a class="link back" href="${returnUrl}" onclick="javascript:stopPropagetion();">
								<span></span>
								返回
							</a>
						</div>
			...
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td>
				       ...
				       <br/> -->
						<div id="frmDefLayout">
							<div id="editor" position="center" style="overflow: hidden; height: 400px; width: 100%;">
								<textarea id="html" name="html" style="height: 400px; width: 95%;">${fn:escapeXml(bpmFormDef.html) }</textarea>
							</div>
						</div>
					</td>
				</tr>
