...
<body>      
	<div class="panel">
		...
		<div class="panel-body">
			    ...
			    <display:table name="bpmDefinitionList" id="bpmDefinitionItem" requestURI="selector.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
					<display:column title="${checkAll}" media="html" style="width:30px;">
							<c:choose>
								...
								<input type="radio" class="pk" name="defId" value="${bpmDefinitionItem.defId}#${bpmDefinitionItem.subject}#${bpmDefinitionItem.defKey}#${bpmDefinitionItem.actDefId}">	
								</c:when>
								<c:otherwise>
						  		<input type="checkbox" class="pk" name="defId" value="${bpmDefinitionItem.defId}#${bpmDefinitionItem.subject}#${bpmDefinitionItem.defKey}#${bpmDefinitionItem.actDefId}">
								</c:otherwise>
							</c:choose>
			...
			</div><hotent:paging tableId="bpmDefinitionItem" showExplain="false"/>
