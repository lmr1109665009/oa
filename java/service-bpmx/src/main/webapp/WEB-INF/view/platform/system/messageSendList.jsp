					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<ul class="row">
										...
										<li><span class="label">发送时间:</span><input  name="Q_beginsendTime_DL"  class="inputText datetime" value="${param['Q_beginsendTime_DL']}"/>
										<span class="label label_line">_ </span><input  name="Q_endsendTime_DG" class="inputText datetime" value="${param['Q_endsendTime_DG']}"/></li>
				...
				<div class="panel-body">
				    ...
				    <display:table name="messageSendList" id="messageSendItem" requestURI="list.ht" 
						...
						<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
						    <c:if test="${longTime-messageSendItem.sendTime.time <= spanTime}">
							<a href="edit.ht?id=${messageSendItem.id}" class="link edit">编辑</a>  | 
							</c:if>
							...
							<a href="get.ht?id=${messageSendItem.id}" class="link detail">详情</a>  | 
