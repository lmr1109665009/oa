...
<body>
	<div id="defLayout">
			<div position="center" style="height:580px;">
				<c:if test="${hasRefer eq true}">
					<div id="refer-div">
						<table class="table-detail">
							<tr>
								<th width="102">引用的流程:</th>
								<td>
				...
				<iframe id="processRunListFrame" name="processRunListFrame" height="100%"
					width="100%" frameborder="0"
					src="${ctx}/platform/bpm/bpmReferDefinition/actInstSelector.ht?hasRefer=${hasRefer }&defId=${defId}"></iframe>
			</div>
			...
			<div position="bottom"  class="bottom" style="height:30px;" >
				...
				<a href="javascript:;" id="btnSelect" class="button" onclick="selectInst()" style="margin-right:10px;" ><span class="icon ok"></span><span class="chosen">确认</span></a>
			</div>
		</div>
	</div>
