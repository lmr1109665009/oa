	...
	<div class="hide-panel">
		...
		<c:set var="checkAll">
				...
				<display:column title="${checkAll}" media="html" style="width:30px;">
					<input type="checkbox" class="pk" name="typeId"
						value="${bpmDefinitionItem.typeId}">
				</display:column>
				...
				<display:column titleKey="序号" media="html" style="width:40px;" >
					...
					<display:column titleKey="流程名称" sortable="true" sortName="subject" >
						   ${f:subString(bpmDefinitionItem.subject)}
					</display:column>
					...
					<display:column title="管理" media="html" style="width:100px;" class="opsBtnb">
						<a href="javaScript:void(0)"  onclick="FlowUtil.startFlow(${bpmDefinitionItem.defId},'${bpmDefinitionItem.actDefId}')" title="${bpmDefinitionItem.subject}"  class="link add">新建</a>
					</display:column>
				</display:table>
