	...
	<div class="panel">
				...
				<div class="panel-search">
					<form id="searchForm" method="post" action="actInstSelector.ht">
						...
						<div style="display: none;">
							...
							<input id="hasRefer" type="hidden" name="hasRefer" value="${hasRefer }"/>
							<input id="defId" type="hidden" name="defId" value="${defId }" />
						</div>
					</form>
				</div>
			</div>
			<div class="panel-body">
				...
				<display:table name="processRunList" id="processRunItem" requestURI="actInstSelector.ht" sort="external" cellpadding="1"
					...
					<display:column title="工单号" sortable="true" property="globalFlowNo" style="width:80px;"></display:column>
					<display:column title="请求标题" sortable="true" sortName="subject" style="text-align:center;width:220px;">
					...
					<display:column title="创建日期" sortable="true" sortName="createtime" style="width:70px;">
						<fmt:formatDate value="${processRunItem.createtime}"
							pattern="yyyy-MM-dd " />
					</display:column>
					<display:column title="结束日期" sortable="true" sortName="endTime" style="width:70px;">
						<fmt:formatDate value="${processRunItem.endTime}"
							pattern="yyyy-MM-dd " />
					</display:column>
					<display:column title="持续时间" sortable="true" sortName="duration" style="width:70px;">
