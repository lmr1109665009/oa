				...
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><a class="link add" href="javascript:;" onclick="addVar('add','')" ><span></span>添加</a></div>
							<div class="l-bar-separator"></div>
				...
				<div class="panel-body">
					    ...
					    <display:table name="bpmDefVarList" id="bpmDefVarItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
							...
							<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
								...
								<a href="get.ht?varId=${bpmDefVarItem.varId}&actDefId=${actDefId}" class="link detail">详情</a>  |  --%>
								<a onclick="addVar('edit','${bpmDefVarItem.varId}')" class="link flowDesign" href="javascript:;">编辑</a>
							</display:column>
						</display:table>
