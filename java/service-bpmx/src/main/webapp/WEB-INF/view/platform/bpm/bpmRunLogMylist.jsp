...
<body>
	...
	<div class="hide-panel">
							...
							<li>
								...
								<select name="Q_operatortype_S" class="select" value="${param['Q_operatortype_S']}">
									<option value="">--全部--</option>
										...
										<option value="2" <c:if test="${param['Q_operatortype_S'] == 2}">selected</c:if>>撤销</option>
		...
		<div class="panel-body">
			    ...
			    <display:table name="bpmRunLogList" id="bpmRunLogItem" requestURI="mylist.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
					...
					<display:column title="操作类型" sortable="true" style="width:150px;" sortName="operatortype">
						<c:choose>
							...
							<c:when test="${bpmRunLogItem.operatortype eq 2}"><span class="red">撤销</span></c:when>
