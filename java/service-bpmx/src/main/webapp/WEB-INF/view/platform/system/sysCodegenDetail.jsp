...
<script type="text/javascript">
	...
	function showResponse(responseText) {
		...
		if (obj.isSuccess()) {
			...
			$.ligerDialog.err("提示信息","代码生成失败!",obj.getMessage());
		}
	}
...
<style type="text/css">
	...
	#codeDetail{overflow: hidden!important;}
    .table-list .inputText{width:80%}
	.shortLi { min-width:150px!important;}
	.h100{height: 100%;}
	.l-layout-left{
		overflow-y:scroll;
	}
	.l-layout-left,#codeDetail{
    -ms-overflow-style: -ms-autohiding-scrollbar;
}
.l-layout-left::-webkit-scrollbar,#codeDetail::-webkit-scrollbar{
    width: 6px;
    height: 6px;
    background: transparent;
    border-radius: 6px;
}
.l-layout-left::-webkit-scrollbar-thumb,#codeDetail::-webkit-scrollbar-thumb{
    -webkit-border-radius: 6px;
    background-color: rgba(100,100,100,0.4);
}
.l-layout-left::-webkit-scrollbar-corner,#codeDetail::-webkit-scrollbar-corner{
				...
				<ul class="row">
					<li><!-- <span class="label">是否覆盖原有文件:</span><input type="checkbox" name="override" value="1" /> -->
						<span class="label">流程定义:</span>
							...
							<input type="button" value="选择..." onclick="selectFlow()"/>
