...
<div class="panel">
		...
		<div class="panel-body">
				<table id="resourcesTable" class="table-detail" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<th width="30%">资源名称:  <span class="required">*</span></th>
						...
						<tr>
							<th width="30%">资源图标: </th>
							<td>
								<input type="hidden" id="iconfont" name="iconfont" value="${resources.iconfont}"  class="inputText"/>
								<%-- <img id="iconImg" alt="" src="${resources.icon}" <c:if test="${resources.icon==null}">style="display:none;"</c:if>> --%>
	
								<i id="iconImg" class="${resources.iconfont}" <%-- <c:if test="${resources.iconfont==null}">style="display:none;"</c:if> --%>></i>
								<a class="link" href="javascript:selectIcon();">选择</a>
							</td>
						</tr>
						<tr>
							<th width="30%">默认地址: </th>
							<td><input type="text" id="defaultUrl" name="defaultUrl" style="width:80%" value="${resources.defaultUrl}"  class="inputText"/>
						</tr>
						<tr>
							<th width="30%">是否有子节点: </th>
							<td>
