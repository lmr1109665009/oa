			...
			<div class="hide-panel">
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="l-bar-separator"></div>
							<div class="group"><f:a alias="delFormDialog" action="del.ht" css="link del" showNoRight="false" ><span></span>批量删除</f:a></div>
							<div class="l-bar-separator"></div>
							<div class="group">
				...
				<div class="panel-body">
					    ...
					    <display:table name="bpmFormDialogList" id="bpmFormDialogItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
							...
							<display:column title="管理" media="html" style="width:220px;" class="opsBtnb">
								...
								<a href="del.ht?id=${bpmFormDialogItem.id}" class="link del">删除</a>
							</display:column>
						</display:table>
