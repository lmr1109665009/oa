...
<body>
	...
	<div class="panel-toolbar">
		<div class="toolBar">
			<div class="group">
				<a class="link save" id="btnSearch">
					<span></span>
					保存
				</a>
			</div>
	...
	<div class="panel-body">
		<form id="bpmNodeMessageForm" method="post" action="save.ht">
			<div class="panel-detail">
					...
					<div class="content">
						...
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<th width="20%">发送:</th>
								<td>
									<input type="checkbox" id="sendMail" name="sendMail" value="1" <c:if test="${mailMessage.isSend==1}">checked="checked"</c:if> />
								</td>
							</tr>
							<tr>
								<th width="20%">邮件主题:</th>
								<td>
									<input type="text" id="subject_mail" name="subject_mail" value="${mailMessage.subject}" class="inputText" style="width: 325px !important" />
								</td>
							</tr>
							<tr>
				...
				<div class="foldBox">
					<div class="title">内部消息</div>
					<div class="content">
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<th width="20%">发送:</th>
								<td>
									<input type="checkbox" id="sendInner" name="sendInner" value="1" <c:if test="${innerMessage.isSend==1}">checked="checked"</c:if> />
								</td>
							</tr>
							<tr>
								<th width="20%">消息主题:</th>
								<td>
									<input type="text" id="subject_inner" name="subject_inner" value="${innerMessage.subject}" class="inputText" style="width: 324px !important" />
								</td>
							</tr>
							<tr>
				...
				<div class="foldBox">
					<div class="title">手机短信</div>
					<div class="content">
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<th width="20%">发送:</th>
								<td>
									<input type="checkbox" id="sendMobile" name="sendMobile" value="1" <c:if test="${smsMessage.isSend==1}">checked="checked"</c:if> />
								</td>
							</tr>
							<tr>
