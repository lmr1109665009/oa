...
<script type="text/javascript">
	...
	function exportXml(){	
		...
		var url=__ctx + "/platform/bpm/bpmFormQuery/exportXml.ht?tableIds="+tableIds;
		if (tableIds  ==''){
	...
	//导入自定义查询
	function importXml(){
		var url=__ctx + "/platform/bpm/bpmFormQuery/import.ht";
		ImportExportXml.showModalDialog({url:url,title:'导入自定义查询'});
	}
</script>
</head>
<body>
