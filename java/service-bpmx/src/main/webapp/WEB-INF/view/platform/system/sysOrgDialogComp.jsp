...
<head>
	...
	<script type="text/javascript">
        ...
        $(function() {
            ...
            var  src="${ctx}/platform/system/sysOrg/selectorComp.ht?isSingle=${param.isSingle}&type="+type+"&typeVal="+typeVal;
            $("#orgFrame").attr("src",src);
            var orgTreetop1 =$(".l-layout-header").height()||0;
            var orgTreetop2 =$("#demensionId").height()||0;
            var orgTreetop3 =$(".tree-toolbar").height()||0;
            $("#orgTree").height($("#defLayout").height()-orgTreetop1-orgTreetop2-orgTreetop3-25)
        });
        ...
        function loadTree(value) {
            var setting = {
                ...
                async: {
                    enable: true,
                    url:"${ctx}/platform/system/sysOrg/getCompTreeData.ht?demId="+value+"&type="+type+"&typeVal="+typeVal,
            ...
            var url="${ctx}/platform/system/sysOrg/getCompTreeData.ht?demId="+value+"&type="+type+"&typeVal="+typeVal;
        ...
        function treeClick(event, treeId, treeNode) {
            ...
            var demId = $("#demensionId").val();
            var url = "${ctx}/platform/system/sysOrg/selectorComp.ht?orgId=" + orgId + "&type="+type+"&typeVal="+typeVal+"&demId=" + demId+"&isSingle=${param.isSingle}";
...
<div id="defLayout">
	...
	<div position="center">
		...
		<iframe id="orgFrame" name="orgFrame" height="100%" width="100%"
...
<div position="bottom"  class="bottom" style='margin-top:10px;'>
	...
	<a href='#' class='button' onclick="selectOrg()" style="margin-right:10px;" ><span class="icon ok"></span><span >确定</span></a>
