...
<div class="panel">
	<div class="panel-search" moreHeight="30">
		<form action="selectorComp.ht?" id="searchForm" method="POST" target="orgFrame">
			<ul class="row">
				<li>
				...
				<li>
				<li><button class="btn" onclick="$('#searchForm').submit()">查询</button></li></ul>
	...
	<div class="panel-body">
		...
		<display:table name="sysOrgList" id="sysOrgItem" requestURI="selectorComp.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
			<display:column title="${checkAll}" media="html" style="width:30px;">
				...
				<input type="hidden" name="orgName" value="${sysOrgItem.orgPathname}">
			</display:column>
		...
		<hotent:paging tableId="sysOrgList" showExplain="true"/>
	</div></div>
</body>
</html>