						...
						<tr>
							...
							<td>
								<div style="padding: 5px">
									<a href="javascript:;" onclick="addCondScript(this)" class="link var" title="条件脚本">条件脚本</a>
									<a href="javascript:;" onclick="addScript(this)" class="link var" title="流程脚本">流程脚本</a>
								</div>
							</td>
						</tr>
						<tr >
