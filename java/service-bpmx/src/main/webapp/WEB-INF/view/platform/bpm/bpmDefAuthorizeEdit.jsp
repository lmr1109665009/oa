...
<body>
			...
			<form id="bpmDefAuthorizeForm" method="post" action="save.ht">
				...
				<table class="table-detail" cellpadding="0" cellspacing="0" border="0">				 
					...
					<tr>
						<th width="20%">权限类型:</th>
						<td>
							<label><input type="checkbox" name="authorizeTypes" value="start" onclick="javascript: changeAuthorizeType()" <c:if test="${fn:contains(bpmDefAuthorize.authorizeTypes,'start')}" >checked="checked"</c:if> />启动&nbsp;&nbsp;</label>
							<label><input type="checkbox" name="authorizeTypes" value="management" onclick="javascript: changeAuthorizeType()" <c:if test="${fn:contains(bpmDefAuthorize.authorizeTypes,'management')}" >checked="checked"</c:if> />定义&nbsp;&nbsp;</label>
							<label><input type="checkbox" name="authorizeTypes" value="task" onclick="javascript: changeAuthorizeType()" <c:if test="${fn:contains(bpmDefAuthorize.authorizeTypes,'task')}" >checked="checked"</c:if> />任务&nbsp;&nbsp;</label>
							<label><input type="checkbox" name="authorizeTypes" value="instance" onclick="javascript: changeAuthorizeType()" <c:if test="${fn:contains(bpmDefAuthorize.authorizeTypes,'instance')}" >checked="checked"</c:if> />实例&nbsp;&nbsp;</td></label>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<div class="group">
								<a class="link users" href="javascript: selectBpmDefUser('${bpmDefAuthorize.id}');" ><span></span>选择</a>
							</div>
							<div class="l-bar-separator"></div>
							<div class="group">
					...
					<tr class="">
						...
						<td>
							...
							<div class="group">
								<a class="link users" href="javascript: selectBpmDefAct('${bpmDefAuthorize.id}');" ><span></span>选择</a>
							</div>
							<div class="l-bar-separator"></div>
							<div class="group">
							...
							<div class="group">
							     <div id="am_right_div">
							     	 &nbsp;&nbsp;定义:(
								     	 <label><input type="checkbox" id="m_rightEdit" name="m_right" onclick="selectCheckbox('m_rightEdit')"  value="m_edit" >设计</label>
									     <label><input type="checkbox" id="m_rightDel" name="m_right"  onclick="selectCheckbox('m_rightDel')"  value="m_del" >删除</label>
									     <label><input type="checkbox" id="m_rightStart" name="m_right" onclick="selectCheckbox('m_rightStart')" value="m_start" >启动</label>
									     <label><input type="checkbox" id="m_rightSet"  name="m_right" onclick="selectCheckbox('m_rightSet')"  value="m_set" >设置</label>
	<!-- 								     <input type="checkbox" id="m_rightInternational"  name="m_international" onclick="selectCheckbox('m_rightInternational')"  value="m_international" >国际化 -->
									     <label><input type="checkbox" id="m_rightClean"  name="m_right" onclick="selectCheckbox('m_rightClean')"  value="m_clean" >清除数据</label>
							     	 )
							     </div>
							     <div id="ai_right_div">
								     &nbsp;&nbsp;实例:(
									     <label><input type="checkbox" id="i_rightDela" name="i_right"  onclick="selectCheckbox('i_rightDela')"  value="i_del" >删除</label>
									     <label><input type="checkbox" id="i_rightLoga" name="i_right" onclick="selectCheckbox('i_rightLoga')" value="i_log" >日志</label>
							         )
							     </div>
							</div>
