				...
				<c:otherwise>
						...
						<table id="tableid" class="table-detail" cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<!--  <th>组织代码:</th>
								<td><span class="green">${sysOrg.orgCode}</span></td>-->
							</tr>
							<!-- 
							<tr>
								<th>微信代码:</th>
								<td colspan="3"><span class="green">${sysOrg.code}</span></td>
							</tr> -->
							<tr>
								<th width="20%">组织名称:</th>
								<td colspan="3"><span class="green">${sysOrg.orgName}</span></td>
								<!-- <th width="20%">建立人:</th>
								<td width="30%">${sysOrg.createName}</td> -->
							</tr>
							<tr>
