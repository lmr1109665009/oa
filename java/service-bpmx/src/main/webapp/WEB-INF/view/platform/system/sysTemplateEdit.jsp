...
<script type="text/javascript">
	$(function() {
		...
		var mailEditor = new baidu.editor.ui.Editor
		...
		mailEditor.render("htmlContent"); 
		valid(showRequest,showResponse);
		$("a.save").click(function() {
			$('#htmlContent').val(mailEditor.getContent());
						...
						<tr>
							...
							<td>
								<select name="useType">
									...
									<option value="10"<c:if test="${sysTemplate.useType eq 10}"> selected="selected"</c:if>>被沟通人批准</option>
