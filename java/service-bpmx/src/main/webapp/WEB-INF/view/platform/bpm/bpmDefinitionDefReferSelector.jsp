...
<div id="bpmTagLayoutt">
	<div position="center" >
		...
		<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group">
						<a class="link search search-show" id="btnSearch"><span></span>查询</a>  
					</div>
				</div>
			</div>
			<div class="panel-search">
				<form id="searchForm" method="post" action="defReferSelector.ht">
					...
					<ul class="row">
						<li><span class="label">流程标题:</span><input type="text" name="Q_subject_SL"  class="inputText" style="width:120px;"/>	</li>
						<%--<li><span class="label">流程定义Key:</span><input type="text" name="Q_defKey_SL"  class="inputText" style="width:120px;"/>--%>
						</li><li><span class="label" >创建时间:</span><input type="text" name="Q_createtime_DL"  class="inputText date" style="width:120px;"/>
						<span class="label label_line">_ </span><input name="Q_endcreatetime_DG" class="inputText date" style="width:120px;"/>
					</li></ul>
				</form>
			</div>
