...
<!-- ueditor自定义控件 -->
<!-- 下面是编辑器模式的字段控件 -->
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/hidedomain/hidedomain.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/textinput/textinput.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/textarea/textarea.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/checkbox/checkbox.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/radioinput/radioinput.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/selectinput/selectinput.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/dictionary/dictionary.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/personpicker/personpicker.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/departmentpicker/departmentpicker.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/rolepicker/rolepicker.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/positionpicker/positionpicker.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/datepicker/datepicker.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/officecontrol/officecontrol.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/myeditor/myeditor.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/attachement/attachement.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/websigncontrol/websigncontrol.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/pictureshowcontrol/pictureshowcontrol.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/processinstance/processinstance.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/subtable/subtable.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/js/ueditor1433/extend/decimaltopercent/decimaltopercent.js"></script>
...
<body style="overflow: hidden">
	<div>
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group">
					<a class="link save" id="btnSaveForm" href="#">
						<span></span>
						保存
					</a>
				</div>
				...
				<div class="group">
					<a class="link run" id="btnNext" href="#">
						<span></span>
						下一步
					</a>
				</div>
				...
				<div class="group">
					<a class="link  del" href="javascript:window.close();">
						<span></span>
						关闭
					</a>
				</div>
		...
		<form id="bpmFormDefForm" method="post" name="bpmFormDefForm">
			...
			<table cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 4px;" class="table-detail">
				<tr style="height: 25px;">
					...
					<td>
						&nbsp;
						<input id="subject" type="text" name="subject" value="${bpmFormDef.subject}" validate="{required:true}" class="inputText" style="width: 80%" />
					</td>
					<th>表单别名:</th>
					<td>
						&nbsp;
						<input id="formKey" type="text" name="formKey" value="${bpmFormDef.formKey}" <c:if test="${bpmFormDef.formDefId>0 }">readonly='readonly'</c:if> validate="{required:true}" class="inputText" style="width: 80%" />
					</td>
					<th>表单描述:</th>
					<td>
						&nbsp;
						<input id="formDesc" type="text" name="formDesc" value="${bpmFormDef.formDesc}" class="inputText" style="width: 80%" />
					</td>
			...
			<div title="表单设计">
				<div id="editor" position="center" style="overflow: hidden; height: 100%;">
					<textarea id="txtHtml">${fn:escapeXml(bpmFormDef.html) }</textarea>
