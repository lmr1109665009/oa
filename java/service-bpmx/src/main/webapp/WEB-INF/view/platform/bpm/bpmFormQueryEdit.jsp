...
<head>
	...
	<script type="text/javascript">
		...
		function showSettingDialog(dsName,objectname,istable,id){
			...
			var url=__ctx+"/platform/bpm/bpmFormQuery/setting.ht?dsName=" +dsName +"&objectName=" + objectname + "&istable=" + istable +"&id=" + id;
			url=url.getNewUrl();
			DialogUtil.open({
                height:600,
                width: 800,
							...
							<td colspan="3" valign="top">
								...
								<c:choose>
									<c:when test="${bpmFormQuery.id==0}">
										<br>
										<select id="objname" name="objName" size="10" style="width:350px;height:150px">
										</select>
