...
.table-grid .button{float: left;height:20px;line-height: 20px;margin: 0 0 0 10px;padding:5px 15px;}
.judgeExp input{ height:28px;}
.left{ float: left;}
.short-input{ margin-left: 10px; height:28px;}
</style>
<body>
	<div class="panel">
		...
		<div class="panel-body">
			<fieldset style="margin: 5px 0px 5px 0px;" zone="team" >
					...
					<div id="ruleDiv" style="border:1px solid #ccc;margin:5px 0 0 0;"></div>
			</fieldset>
			<fieldset style="margin: 5px 0px 5px 0px;" zone="team" >
