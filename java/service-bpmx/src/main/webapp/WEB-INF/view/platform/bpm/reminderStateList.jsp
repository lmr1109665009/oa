					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<ul class="row">
												...
												<li><span class="label">催办时间:</span> <input  name="Q_beginreminderTime_S"  class="inputText date" value="${param['Q_beginreminderTime_S']}"/>
												<span class="label label_line">_ </span><input  name="Q_endreminderTime_S" class="inputText date" value="${param['Q_endreminderTime_S']}"/></li>
					...
					<div class="panel-data">
					    ...
					    <display:table name="reminderStateList" id="reminderStateItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
								...
								<a href="get.ht?id=${reminderStateItem.id}" class="link detail">详情</a>  | 
							</display:column>
						</display:table>
