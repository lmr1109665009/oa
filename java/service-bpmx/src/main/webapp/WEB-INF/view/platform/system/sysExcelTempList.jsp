		...
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<ul class="row">
						<li><span class="label">模板代码:</span><input type="text" name="Q_tempCode_SL"  class="inputText" />
						</li>
						<li><span class="label" >模板名称:</span><input type="text" name="Q_tempName_SL"  class="inputText" />
						</li>
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysExcelTempList" id="sysExcelTempItem" requestURI="list.ht?__FILTERKEY__=${busQueryRule.filterKey}&__FILTER_FLAG__=${busQueryRule.filterFlag}" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:150px;" class="opsBtnb">
					...
					<a href="get.ht?id=${sysExcelTempItem.id}" class="link detail">详情</a>  | 
