		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><f:a alias="delDraft" css="link del" action="delDraft.ht" showNoRight="false"><span></span>批量删除</f:a></div>
		...
		<div class="panel-body">
			    ...
			    <display:table name="processRunList" id="processRunItem" requestURI="myForm.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
					...
					<display:column title="管理" media="html" style="width:150px" class="opsBtnb">
						<f:a alias="delDraft" href="delDraft.ht?runId=${processRunItem.runId}" css="link del">删除</f:a>					
						<a href="javascript:;" onclick="checkFormChange('${processRunItem.runId}')" class="link run">编辑</a>
