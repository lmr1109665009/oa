...
<script type="text/javascript">
	...
	$(function() {
		...
		valid(showRequest,function(){});
           $("#tabScript").ligerTab({onAfterSelectTabItem:function(tabid){
				var key=tabid.replace("tab_","");
...
<c:set var="signScriptModel" value="${map.type7}"></c:set>
				...
				<form id="bpmNodeScriptForm" method="post" action="save.ht">
					<div id="tabScript" >
						<c:if test="${type eq 'startEvent' || type eq 'subProcess' || type eq 'subStartEvent' }">
							<div tabid="tab_startScript" title="开始事件">
						...
						<c:if test="${type eq 'endEvent' || type eq 'subProcess'}">
							<div tabid="tab_endScript" title="结束事件">
								<table class="table-detail" cellpadding="0" cellspacing="0" border="0"  >
									<tr>
						...
						<c:if test="${type eq 'script' }">
							<div tabid="tab_scriptScript" title="脚本代码">
						...
						<c:if test="${type=='multiUserTask'||type=='userTask' }">
							  ...
							  <div tabid="tab_preBeforeScript" title="任务创建前置脚本">
				              ...
				              <div tabid="tab_preScript" title="任务创建后置脚本">
				              ...
				              <div tabid="tab_afterBeforeScript" title="任务结束前置脚本" >
							     <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<th width="20%">脚本描述:<span class="required">*</span> </th>
												<td>
				              ...
				              <div tabid="tab_afterScript" title="任务结束后置脚本" >
							     <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<th width="20%">脚本描述:<span class="required">*</span> </th>
												<td>
						 ...
						 <c:if test="${type eq 'signExecute'}">
							<!-- 会签执行事件脚本 -->
							<div id="tab_signExecuteScript" title="会签完成事件脚本">
								<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
									<tr>
										<th width="20%">说明:<span class="required">*</span> </th>
										<td>
											...
											<input type="hidden"  name="scriptType" value="7"  class="inputText"/>
										</td>
									</tr>
									<tr>
										<th width="20%" >脚本:<span class="required">*</span> </th>
