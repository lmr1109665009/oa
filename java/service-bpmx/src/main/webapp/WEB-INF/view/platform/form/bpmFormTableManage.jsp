	...
	<script type="text/javascript">
		...
		function zTreeOnRightClick(event, treeId, treeNode) {
			...
			if (treeNode) {
				...
				curMenu=FormTableMenu.getMenu(treeNode, handler);
...
<body>
   	<div id="defLayout" >
         <div position="left" title="表分类管理" style="overflow: auto;float:left;width:100%">
         ...
         <div position="center">
        	<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/form/bpmFormTable/list.ht"></iframe>
         </div>
     </div>
</body>
</html>
