		...
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					...
					<li>
						<span class="label">错误日期:</span><input  name="Q_beginerrordate_DL"  class="inputText date" value="${param['Q_beginerrordate_DL']}" />

						<span class="label label_line">_ </span><input  name="Q_enderrordate_DG" class="inputText date"  value="${param['Q_enderrordate_DG']}" />
					</li>
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysErrorLogList" id="sysErrorLogItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
				...
				<display:column title="管理" media="html" style="width:100px;" class="opsBtnb">
					<a href="get.ht?id=${sysErrorLogItem.id}" class="link detail">详情</a>  | 
