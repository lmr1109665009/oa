            ...
            <%@include file="/commons/include/form.jsp" %>
                ...
                <style type="text/css">
                    ...
                    .table-detail .link {
                        ...
                        background: white;
                        color: #666;
                        border: 1px solid rgba(169, 169, 169, 0.31);
                    }
                ...
                <script type="text/javascript">
                    ...
                    function handSave(generate) {
                        ...
                        if (!categoryId) {
                            categoryId = "${param['categoryId']}" ? "${param['categoryId']}" : 0;
                        }
                        //处理主表字段。
                    ...
                    function showResponse(data) {
                        ...
                        if (obj.isSuccess()) { //成功
                            $.ligerDialog.confirmEx("操作成功!是否继续操作？", "提示", function (rtn) {
                                if (!rtn) {
                    ...
                    function autoGetTableKey(inputObj) {
                        ...
                        $.post(url, {
                            ...
                            if (json.result == 1) {
                                ...
                                if (json.cause && json.cause == "exist") {
                                    repeatCounter++;
                                    autoGetTableKey(inputObj);
                                } else {
                                    $.ligerDialog.err("提示信息", "生成表别名失败!", json.message);
                                }
                            }
                        });
                    }
                    ...
                    <div class="panel-detail">
                        <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <th width="8%">
                                    <span style="color: red">*</span>表属性: </th>
                                <td width="92%">
                                    <label>
                                        <input type="radio" name="isMain" value="1" checked="checked" />主表</label>
                                    <label>
                                        <input type="radio" name="isMain" value="0" />从表</label>
                                </td>
                            </tr>
                            <tr id="spanMainTable" style="display:none;">
                                <th width="8%">
                                    <span style="color: red">*</span>所属主表:</th>
                                <td width="92%">
                                    <div>
                                        ...
                                        <div>
                                            <label>
                                                <input type="radio" value="0" checked="checked" name="publishedAsMain" />未生成的表</label>
                                            <label>
                                                <input type="radio" value="1" name="publishedAsMain" />已生成的表</label>
                            ...
                            <tr>
                                <th width="8%">
                                    <span style="color: red">*</span>表名: </th>
                                <td width="92%">
                            ...
                            <tr>
                                <th width="8%">
                                    <span style="color: red">*</span>表别名: </th>
                                <td width="92%">
                                    <input type="text" id="name" name="name" maxlength="30" class="inputText longInputText" />
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <span style="color: red">*</span>表分类:</th>
                                <td colspan="1">
                                    <input class="catComBo" catKey="FORM_TABLE_TYPE" valueField="categoryId" catValue="" name="typeName" height="150" width="235"
                                    />
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <span style="color: red">*</span>字段:</th>
                                <td>
                                    <div class="group">
                                        <a onclick="clickAddRow()" class="link add">
                                            <span></span>添加</a>
                                    </div>
                                    <div class="l-bar-separator"></div>
                                    <div class="group">
                                        <a id="moveupField" class="link moveup">
                                            <span></span>上移</a>
                                    </div>
                                    <div class="l-bar-separator"></div>
                                    <div class="group">
                                        <a id="movedownField" class="link movedown">
                                            <span></span>下移</a>
                                    </div>
                                    <div class="l-bar-separator"></div>
                                    <%--<div class="group"><a id="delField" class="link del "><span></span>删除</a></div>--%>
                                        <c:if test="${canGenerate }">
                                            <div class="group generate hidden">
                                                <a class="link table" href="javascript:;">
                                                    <span></span>生成表</a>
                                            </div>
                                        </c:if>
