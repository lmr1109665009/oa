...
<head>
	...
	function exitSwitch(account){
    	...
    	var url = "${ctx}/j_spring_security_exit_user?j_username=" + account;
    	$.get(url, function(result){
    		if(result.status == 0){
    			top.location.href = "${ctx}/platform/console/main.ht";
    		} else {
    			$.ligerDialog.err("提示信息","退出切换用户失败!",result.message);
    		}
    	});
	}
</script>
...
<body>
                        ...
                        <div class="copy">&copy;权所有 象翌微链科技发展有限公司 2008-2014 粤ICP备09066681号</div>
                        </center>
