							...
							<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main" style="border-width: 0!important;">
								...
								<tr>
									...
									<td>
										...
										<input style="margin-right:5px;" type="button" value="选择" ng-click="selectFlow()"/>
										<input style="margin-right:5px;" type="button" value="重置" ng-click="cancel()"/>
									</td>
								</tr>
								<tr>
									<th >是否分页:</th>
								...
								<tr>
									...
									<td>
										<select ng-model="dataRightsJson.resetTemp"  validate="{required:true}">
