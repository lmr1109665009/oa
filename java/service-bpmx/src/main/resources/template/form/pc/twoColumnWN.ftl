 	...
 	<#assign rtn>
		...
		<#list fieldList as field>
			...
			<tr>
				...
				<td align="center" style="width:15%;" class="formTitle" nowrap="nowarp"><span>${field.fieldDesc}</span></td>
				<td style="width:35%;" class="formInput"><@input field=field/></td>
		...
		<#list fieldList as field>
			<#if field.controlType == 2 || field.controlType == 9 
				...
				<tr>
					<td align="center" style="width:15%;" class="formTitle" nowrap="nowarp"><span>${field.fieldDesc}</span></td>
					<td style="width:85%;" class="formInput" colspan="3"><@input field=field/></td>
				</tr>
			</#if>
		</#list>
 	</#assign>
...
<#function setTeamField teams>
 	<#assign rtn>
		 <#list teams as team>
		 <tbody id="${team.teamTitle}" parser="teamtable">
				<tr><td colspan="4" class="teamHead">${team.teamName}</td></tr>
...
<br />
<table cellpadding="2" cellspacing="0" border="1" class="formTable formTableWN" parser="addpermission">
	<tr><td colspan="4"  class="formHead" >${table.tableDesc}</td></tr>
	<#if teamFields??>
		<#if isShow>
			<#if showPosition == 1>
