 ...
 */
public class AtsShiftType extends BaseModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8713043516911707857L;
	// 主键
	protected Long id;
	// 编码
	...
	{
		if (!(object instanceof AtsShiftType)) 
		{
			return false;
		}
		AtsShiftType rhs = (AtsShiftType) object;
