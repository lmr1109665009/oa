...
@WebService(endpointInterface="com.suneee.platform.webservice.api.UserOrgService",
...
public interface UserOrgService {
	 ...
	 * @since  1.0.0
	 */
	@WebMethod(operationName="getOrg")
	String getOrg(@WebParam(name = "json") String json);
	
	/**
	 * 获取岗位，根据json格式传来的参数
	 * @param json	：{action:getByPosId,posId:posId}
	 * @return 
	 * String
	 * @exception 
	 * @since  1.0.0
	...
	String getPos(@WebParam(name = "json") String json);
	 ...
	 * @return
	 */
	@WebMethod(operationName="getSysOrgListByOrgTactic")
	String getSysOrgListByOrgTactic();
	 ...
	 * @return
	 */
	@WebMethod(operationName="getUserByOrg")
	String getUserByOrg(@WebParam(name = "orgCode") String orgCode);
	 ...
	 * @return
	 */
	@WebMethod(operationName="getOrgByOrgSupId")
	String getOrgByOrgSupId(@WebParam(name = "orgId") Long orgId);
}
