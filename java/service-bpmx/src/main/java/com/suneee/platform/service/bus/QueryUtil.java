package com.suneee.platform.service.bus;
...
import com.suneee.core.web.query.entity.*;
import com.suneee.core.web.query.scan.SearchCache;
import com.suneee.core.web.query.scan.TableEntity;
import com.suneee.core.web.query.scan.TableField;
import com.suneee.core.web.util.RequestUtil;
import com.suneee.platform.model.bus.BusQueryFilter;
import com.suneee.platform.model.bus.BusQueryRule;
import com.suneee.platform.model.bus.BusQuerySetting;
...
import com.suneee.core.util.StringUtil;
import com.suneee.core.web.query.QueryFilter;
import com.suneee.core.web.query.entity.FieldLogic;
import com.suneee.core.web.query.entity.FieldSort;
import com.suneee.core.web.query.entity.FieldTableUtil;
import com.suneee.core.web.query.entity.Filter;
import com.suneee.core.web.query.entity.FilterJsonStruct;
...
public class QueryUtil {
	...
	private static Map<String, Boolean> getPermission( String displayField, Map<String, Object> rightMap) {
		JSONArray jsonAry = JSONArray.fromObject(displayField);
	 ...
	 * @return
	 */
	public static Map<String, Boolean> getPermissionMap(JSONArray jsonAry, Map<String, Object> rightMap) {
		Map<String, Boolean> map = new HashMap<String, Boolean>();
		if (JSONUtil.isEmpty(jsonAry))
			return map;
		for (Object obj : jsonAry) {
			JSONObject json = JSONObject.fromObject(obj);
			String name = QueryUtil.getRightsName(json);
	...
	public static boolean hasRight(JSONObject permission, Map<String, Object> rightMap) {
		String type = "none";
		if(BeanUtils.isNotEmpty(type) && permission.get("type") != null)
			type = permission.get("type").toString();
