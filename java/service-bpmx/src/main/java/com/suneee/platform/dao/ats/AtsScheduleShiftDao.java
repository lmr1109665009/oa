...
public class AtsScheduleShiftDao extends BaseDao<AtsScheduleShift> {
	...
	public List<AtsScheduleShift> getCalendar(QueryFilter queryFilter) {
		return this.getBySqlKey("getCalendar", queryFilter);
	}

	public void delByFileIdAttenceTime(Long fileId, Date attenceTime) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("fileId", fileId);
		params.put("attenceTime", attenceTime);
		this.delBySqlKey("delByFileIdAttenceTime", params);
	}
