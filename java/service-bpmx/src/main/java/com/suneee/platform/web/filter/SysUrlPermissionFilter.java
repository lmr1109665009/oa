...
import com.suneee.platform.service.system.SysUrlPermissionService;
import com.suneee.platform.service.system.SysUrlRulesService;
...
public class SysUrlPermissionFilter {
	...
	public void initMap(){
		...
		QueryFilter filter = new QueryFilter(ContextUtil.getRequest());
		Map<String, Object> map = new HashMap<String,Object>();
