...
//			userName = user.getFullname();
			userName = ContextSupportUtil.getUsername(user);
		}
		...
		runLog.setMemo(memo);
		runLog.setOrgCode(ContextSupportUtil.getCurrentEnterpriseCode());
		dao.add(runLog);
	}
...
//		runLog.setUsername(user.getFullname());
		runLog.setUsername(ContextSupportUtil.getUsername(user));
		runLog.setRunid(processRun.getRunId());
		runLog.setProcessSubject(processRun.getSubject());
