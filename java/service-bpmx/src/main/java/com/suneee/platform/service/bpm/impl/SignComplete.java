...
import com.suneee.platform.model.bpm.BpmNodeSign;
...
import com.suneee.platform.service.bpm.BpmNodeSignService;
...
import com.suneee.platform.service.bpm.ISignComplete;
import com.suneee.platform.service.bpm.TaskOpinionService;
import com.suneee.platform.service.bpm.TaskSignDataService;
...
public class SignComplete implements ISignComplete {
	...
	private void exeEventScript(ActivityExecution execution, String actDefId, String nodeId, boolean isCompleted){
		BpmNodeScript signNodeScript = bpmNodeScriptService.getScriptByType(nodeId, actDefId, BpmNodeScript.SCRIPT_TYPE_7);
