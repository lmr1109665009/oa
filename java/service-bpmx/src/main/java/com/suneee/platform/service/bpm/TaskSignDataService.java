...
import com.suneee.platform.dao.bpm.TaskSignDataDao;
import com.suneee.platform.model.bpm.BpmRunLog;
import com.suneee.platform.model.bpm.ProcessRun;
import com.suneee.platform.model.bpm.TaskSignData;
...
//			fullname = sysUser.getFullname();
	...
	public void addSign(String userIds,String taskId, String opinion, String informType)throws Exception{
		...
		if (StringUtil.isNotEmpty(opinion)) {
			//添加审批意见
			processRunService.saveAddSignOpinion(taskEntity, opinion, informType, userTaskMap, processRun);
		}
...
//		newSignData.setVoteUserName(sysUser.getFullname());
		newSignData.setVoteUserName(ContextSupportUtil.getUsername(sysUser));
		//添加
		dao.add(newSignData);
	}
