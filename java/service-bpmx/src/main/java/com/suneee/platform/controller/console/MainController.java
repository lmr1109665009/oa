...
import com.suneee.platform.service.system.SysIndexMyLayoutService;
...
public class MainController extends BaseController {
	...
	{	
		SubSystem currentSystem=SubSystemUtil.getCurrentSystem(request);
		List<Resources> resourcesList=resourcesService.getSysMenu(currentSystem,(SysUser) ContextUtil.getCurrentUser(), Resources.FROMTYPE_SERVER);
