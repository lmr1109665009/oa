...
public class BpmFormTableDao extends BaseDao<BpmFormTable>
{
	...
	public Long getMainTableId(Long tableId){
		return this.getBySqlKey("getMainTableId",tableId).get(0).getMainTableId();
	}
	 ...
	 * @return
	 */
	public List<BpmFormTable> getAllUnpublishedMainTable(QueryFilter filter){
		return this.getBySqlKey("getAllUnpublishedMainTable",filter);
	}
	...
	public void judgeHasMoreThanOneTable(Long defId){
		Map<String,Object> params=new HashMap<String,Object>();
		params.put("defId", defId);
		params.put("parentActDefId", "");
		List<BpmFormTable> list=this.getBySqlKey("getByDefId", params);
		if(list.size()>1){
