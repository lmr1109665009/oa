...
import com.suneee.platform.model.bpm.CcMessageType;
...
public class BpmProCopytoService extends BaseService<BpmProCopyto>
{
	...
	public void markCopyStatus(String id){
		if(StringUtils.isEmpty(id)||"0".equals(id))return;
...
//			String copyUserName = executor.getFullname();
			String copyUserName = ContextSupportUtil.getUsername(executor);
	...
	public List<BpmProCopyto> getUserInfoByRunIdAndOrgCode(Long runId,String orgCode){
		return dao.getUserInfoByRunIdAndOrgCode(runId,orgCode);
	}
}
