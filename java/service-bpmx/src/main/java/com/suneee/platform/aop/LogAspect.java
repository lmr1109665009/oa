package com.suneee.platform.aop;
...
import com.suneee.platform.service.system.SysAuditLinkService;
import com.suneee.platform.service.system.SysAuditService;
...
public class LogAspect
{
	...
	static{
		try {
			...
			STATIC_CLASSES.put(Long.class.getSimpleName(), (TemplateHashModel) staticModel.get(Long.class.getName()));
			STATIC_CLASSES.put(Integer.class.getSimpleName(), (TemplateHashModel) staticModel.get(Integer.class.getName()));
			STATIC_CLASSES.put(String.class.getSimpleName(), (TemplateHashModel) staticModel.get(String.class.getName()));
			STATIC_CLASSES.put(Short.class.getSimpleName(), (TemplateHashModel) staticModel.get(Short.class.getName()));
			STATIC_CLASSES.put(Boolean.class.getSimpleName(), (TemplateHashModel) staticModel.get(Boolean.class.getName()));
	...
	// @Around("execution(* com.suneee.platform.controller..*.*(..))")
