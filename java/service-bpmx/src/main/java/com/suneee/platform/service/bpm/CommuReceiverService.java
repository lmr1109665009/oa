...
import com.suneee.platform.dao.bpm.CommuReceiverDao;
import com.suneee.platform.model.bpm.CommuReceiver;
...
//			comm.setReceivername(sysUser.getFullname());
			comm.setReceivername(ContextSupportUtil.getUsername(sysUser));
			dao.add(comm);
		}
	}
