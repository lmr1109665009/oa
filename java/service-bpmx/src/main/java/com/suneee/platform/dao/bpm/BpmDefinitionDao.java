...
import com.suneee.platform.model.bpm.PerOffice;
...
//	}
	...
	/**
	 * 根据formKey获取关联的流程定义ID
	 * @param formKey
	 * @return
	 */
	public List<String> getActDefIdByFormKey(String formKey)
	{
		return this.getSqlSessionTemplate().selectList("getActDefIdByFormKey", formKey) ;
	}
	 ...
	 * @return
	 */
	public BpmDefinition getById(String defId){
		return getUnique("getById", defId);
	}

	public List<BpmDefinition> getByTypeIdList(List<Long> typeIdList) {
		// TODO Auto-generated method stub
		return getBySqlKey("getByTypeIdList", typeIdList);
	}

	public void saveFlow(PerOffice po) {
		// TODO Auto-generated method stub
		insert("insertPerFlow", po);
	}
	...
	public List<BpmDefinition> getByMobileFormKey(String mobileFormKey){
		return this.getBySqlKey("getByMobileFormKey", mobileFormKey);
	}
