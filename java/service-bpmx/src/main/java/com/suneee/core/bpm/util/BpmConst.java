...
public class BpmConst {
	 ...
	 * 会签结束脚本。
	 */
	public static final Integer SignCompleteScript=7;
	 ...
	 * 流程退回到任意节点
	 */
	public static final Integer TASK_BACK_TOANYNODE=3;
...
//	 public static final String ORIGINAL_EXECUTOR="original_executor";
	 ...
	 * 所有意见字段，这个为临时变量。
	 */
	public final static String OPINION_FIELDS="opinionFields";
