...
import com.suneee.core.bpm.graph.Link;
import com.suneee.core.bpm.graph.OrthogonalType;
import com.suneee.core.bpm.graph.Point;
import com.suneee.core.bpm.graph.Port;
import com.suneee.core.bpm.graph.PortType;
import com.suneee.core.bpm.graph.Shape;
import com.suneee.core.bpm.graph.ShapeType;
...
public class TransformUtil {
	...
	/**
	 * 计算表接连类型为com.suneee.core.bpm.graph.ShapeType.ORTHOGONAL的连接的坐标点
	 * @param link 连接
	 * @return 接连的坐标点列表
	 */
	...
	/**
	 * 计算表接连类型为com.suneee.core.bpm.graph.ShapeType.ORTHOGONAL的连接的正交连接类型
	 * @param source 开始节点
	 * @param target 结束节点
	...
	/**
	 * 计算表接连类型为com.suneee.core.bpm.graph.ShapeType.STRAIGHT的连接的坐标点
	 * @param link 连接
	 * @return 接连的坐标点列表
	 */
	...
	/**
	 * 计算表接连类型为com.suneee.core.bpm.graph.ShapeType.FREE的连接的坐标点
	 * @param link 连接
	 * @return 接连的坐标点列表
	 */
