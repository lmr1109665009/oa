package com.suneee.core.bpmn20.util;

import com.suneee.core.bpmn20.ContextFactory;
import com.suneee.core.bpmn20.entity.*;
...
public class BPMN20Util {
	...
	public static Definitions createDefinitions(InputStream is) throws JAXBException, IOException{
		...
		JAXBElement<Definitions> jAXBElement = (JAXBElement<Definitions>) unmarshall(is,
				ObjectFactory.class,
				ObjectFactory.class,
				com.suneee.core.bpmn20.entity.omgdc.ObjectFactory.class,
				com.suneee.core.bpmn20.entity.omgdi.ObjectFactory.class,
				com.suneee.core.bpmn20.entity.ht.ObjectFactory.class,
				com.suneee.core.bpmn20.entity.bpmndi.ObjectFactory.class);
