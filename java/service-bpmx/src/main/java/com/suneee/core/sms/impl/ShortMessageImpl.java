package com.suneee.core.sms.impl;
...
public class ShortMessageImpl implements IShortMessage {
	 ...
	 */
	public void initial() {
		url = PropertyUtil.getByAlias("smsUrl");
		userID = PropertyUtil.getByAlias("smsUserID");
		account = PropertyUtil.getByAlias("smsAccount");
		password = PropertyUtil.getByAlias("smsPassword");
		content = PropertyUtil.getByAlias("smsContent");
		sendTime = PropertyUtil.getByAlias("smsSendTime","");
		sendType = PropertyUtil.getIntByAlias("smssendType",0);
		postFixNumber = PropertyUtil.getByAlias("smsPostFixNumber");
		sign = PropertyUtil.getIntByAlias("smsSign",0);
	}

	/*
	 * (non-Javadoc)
	 * 
	 * @see com.suneee.core.sms.IShortMessage#sendSms(java.util.List,
	 * java.lang.String)
	 */
	@Override
