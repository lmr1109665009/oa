...
public class ZipUtil {
	...
	public static String unZipFile(MultipartFile multipartFile, String destDir) throws Exception {
		//转存文件
		String originalFilename = multipartFile.getOriginalFilename();

		createFilePath(destDir, originalFilename);
		File file = new File(destDir,originalFilename);
		if (file.exists())
			file.delete();
		...
		String fileDir ="";
		zipFile.extractAll(destDir);      // 将文件抽出到解压目录(解压)
