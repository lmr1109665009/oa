 ...
 */
@Controller
@RequestMapping("/mh/codeTable/companyArea/")
public class CompanyAreaController extends UcpBaseController{
	...
	public void del(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try{
			...
			message = new ResultMessage(ResultMessage.Success, "删除企业地区成功!");
		}catch(Exception ex){
