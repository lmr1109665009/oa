 ...
 */
@Alias("aVacationRemain")
public class VacationRemain extends BaseModel{
	/**
	 * 
	 */
	private static final long serialVersionUID = -3544187967603170347L;
	// ID
	protected Long id;
	// 用户Id
	 ...
	 * 计算年假年份
	 */
	protected Integer computeYear = 0;
	...
	public Date getUpdatetime() {
   	...
   	/**
	 * @return the computeYear
	 */
	public Integer getComputeYear() {
		return computeYear;
	}
	/**
	 * @param computeYear the computeYear to set
	 */
	public void setComputeYear(Integer computeYear) {
		this.computeYear = computeYear;
	}
	/**
	...
	public boolean equals(Object object) 
	{
		...
		.append(this.computeYear, rhs.computeYear)
		.isEquals();
	}
	...
	public String toString() 
	{
		...
		.append("computeYear", this.computeYear)
		.toString();
	}
}