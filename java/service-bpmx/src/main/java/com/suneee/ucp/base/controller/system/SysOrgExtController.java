...
public class SysOrgExtController extends UcpBaseController{
	...
	public void downloadTemplate(HttpServletRequest request, HttpServletResponse response) throws IOException {
		// 获取模板文件路径
		String filePath = request.getSession().getServletContext().getRealPath("/WEB-INF/xls/org-template.xls");
	...
	public void exportOrg(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		queryFilter.addFilter("orgCode", ContextSupportUtil.getCurrentEnterpriseCode());
