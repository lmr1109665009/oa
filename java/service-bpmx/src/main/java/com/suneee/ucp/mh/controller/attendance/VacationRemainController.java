 ...
 *</pre>
 */
@Controller("ucpVacationRemainController")
@RequestMapping("/mh/attendance/vacationRemain/")
public class VacationRemainController extends UcpBaseController
{
	...
	public void save(HttpServletRequest request, HttpServletResponse response,VacationRemain vacationRemain) throws Exception
	{
		...
		try{
			...
			vacationLog.setChangeUnit(vacationRemain.getBaseUnit());
			if(oldVacationRemain == null){
				vacationLog.setBeforeValue(0d);
			}else{
