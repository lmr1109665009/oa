 ...
 * 2018.5.14
 */
public class MobileScene extends BaseModel {
    ...
    // 相关流程
    private List<RelateProcess> relProcessList;
	...
	/**
	 * @param subProcessList the subProcessList to set
	 */
	...
	/**
	 * @return the relProcessList
	 */
	public List<RelateProcess> getRelProcessList() {
		return relProcessList;
	}

	/**
	 * @param relProcessList the relProcessList to set
	 */
	public void setRelProcessList(List<RelateProcess> relProcessList) {
		this.relProcessList = relProcessList;
	}
